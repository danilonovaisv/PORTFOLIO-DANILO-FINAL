module.exports = [
  ...
  (a) => {
    ...
    var l = a.i(65802),
      ...
      n = a.i(1299);
    function o(a, b = {}) {
      let { isStatic: c } = (0, d.useContext)(l.MotionConfigContext),
        e = () => ((0, i.isMotionValue)(a) ? a.get() : a);
      if (c) return (0, n.useTransform)(e);
      let f = (0, m.useMotionValue)(e());
      return (
          ...
          () =>
            (function (a, b, c) {
              let d,
                ...
                f = null,
                g = e,
                l = 'string' == typeof e ? e.replace(/[\d.-]/g, '') : void 0,
                m = () => {
                  f && (f.stop(), (f = null));
                },
                n = () => {
    ...
    let s = ({
        ...
        return (0, c.jsxs)('span', {
          className: `word ${'accent' === b ? 'blue-start' : ''} ${'sm' === d ? 'small' : ''}`,
          style: f
            ? { '--trans-duration': '0ms', '--trans-delay-factor': '0ms' }
            : void 0,
          children: [
            (0, c.jsx)('span', { className: 'sr-only', children: a }),
            (0, c.jsx)('span', {
      ...
      t =
        ((b = new Map()),
        ['É', 'intenção,', 'é', 'estratégia,', 'é', 'experiência.'].map((a) => {
          let c = b.get(a) ?? 0;
          return (b.set(a, c + 1), { token: a, occurrence: c });
        })),
      u = [0.33, 1, 0.68, 1];
    a.s(
      [
        ...
        () => {
          ...
          let b = (0, d.useRef)(null),
            h = (0, d.useRef)(null),
            i = (function () {
              q.hasReducedMotionListener.current ||
                (0, p.initPrefersReducedMotion)();
              let [a] = (0, d.useState)(q.prefersReducedMotion.current);
              return a;
            })(),
            [j, k] = (0, d.useState)(!1),
            [l, m] = (0, d.useState)(!1),
            [v, w] = (0, d.useState)(!1),
            [x, y] = (0, d.useState)(!0),
            [z, A] = (0, d.useState)(null);
          ((0, d.useEffect)(() => {
            let a = setTimeout(() => k(!0), 100);
            return () => clearTimeout(a);
          }, []),
            (0, d.useEffect)(() => {
              let a = () => {
                m(!i && window.innerWidth >= 1024);
              };
              return (
                a(),
            ...
            (0, d.useEffect)(() => {
              ...
              let a = new IntersectionObserver(
                ([b]) => {
                  b.isIntersecting && (w(!0), a.disconnect());
                },
                { threshold: 0.2 }
              );
          ...
          let B = (a, b = !1) => {
            ...
            { scrollYProgress: C } = (0, g.useScroll)({
              target: b,
              offset: ['start start', 'end end'],
            });
          ((a = (a) => {
            a <= 0.01 || a >= 0.92 ? B(!0, !0) : null === z && B(!1);
          }),
            (0, d.useInsertionEffect)(
              () => C.on('change', a),
              [C, 'change', a]
            ));
          let D = (0, n.useTransform)(C, [0, 0.15], [1, +!!i]),
            E = (0, n.useTransform)(C, [0, 0.15], [1, i ? 1 : 0.95]),
            F = (0, n.useTransform)(C, [0, 0.15], [0, i ? 0 : -50]),
            G = (0, n.useTransform)(C, [0, 0.25], [0.25, i ? 0.9 : 1]),
            H = (0, n.useTransform)(C, [0, 0.25], ['35%', '0%']),
            I = (0, n.useTransform)(C, [0, 0.25], ['30%', '0%']),
            J = (0, n.useTransform)(C, [0, 0.2], [i ? 4 : 12, 0]),
            K = o(0, { stiffness: 110, damping: 18 }),
            L = o(0, { stiffness: 110, damping: 18 }),
            M = o(0, { stiffness: 110, damping: 18 }),
            N = o(0, { stiffness: 110, damping: 18 }),
            O = { opacity: 0, y: 32 },
            P = { opacity: 0, y: 32 },
            Q = { opacity: 0, y: 32 },
            R = (0, d.useMemo)(
      ...
      `,
              ...
              (0, c.jsx)('div', {
                className:
                  'absolute inset-0 bg-gradient-to-b from-[#f6f7fb] via-white to-[#eef3ff]',
                'aria-hidden': 'true',
              }),
              (0, c.jsx)('div', {
                className:
                  'absolute inset-x-0 top-10 h-40 bg-[radial-gradient(circle_at_top,#c8d9ff_0%,transparent_55%)] opacity-60',
                'aria-hidden': 'true',
              }),
              (0, c.jsxs)(f.motion.div, {
                className:
                ...
                onMouseLeave: () => {
                  (K.set(0), L.set(0), M.set(0), N.set(0));
                },
                children: [
                  (0, c.jsx)(f.motion.div, {
                    style: { opacity: D, scale: E, y: F },
                    className: R,
                    children: (0, c.jsxs)(f.motion.div, {
                      style: { x: K, y: L },
                      className:
                        'flex flex-col justify-center items-start h-full pt-24 md:pt-0 max-w-3xl gap-8 lg:gap-10 pointer-events-auto px-2 sm:px-4',
                      children: [
                        (0, c.jsxs)(f.motion.h1, {
                          initial: O,
                          animate: j ? { opacity: 1, y: 0 } : O,
                          transition: { duration: 0.65, ease: u, delay: 0.2 },
                        ...
                        (0, c.jsx)(f.motion.div, {
                          initial: P,
                          animate: j ? { opacity: 1, y: 0 } : P,
                          transition: { duration: 0.65, ease: u, delay: 0.35 },
                        ...
                        (0, c.jsx)(f.motion.div, {
                          initial: Q,
                          animate: j ? { opacity: 1, y: 0 } : Q,
                          transition: { duration: 0.65, ease: u, delay: 0.5 },
                          className: 'pointer-events-auto',
                          children: (0, c.jsxs)(f.motion.a, {
                            href: '/sobre',
                            whileHover: {
                              scale: 1.04,
                              boxShadow:
                            ...
                            whileTap: { scale: 0.97 },
                            className:
                              'group inline-flex items-center gap-3 rounded-full bg-[#0057FF] px-10 py-5 text-white text-base md:text-lg font-semibold shadow-lg transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white',
                            children: [
                              'get to know me better',
                              (0, c.jsx)('span', {
                                className:
                                  'flex items-center justify-center w-8 h-8 rounded-full bg-white/25 group-hover:bg-white/35 transition-colors',
                                children: (0, c.jsx)(e.ArrowRight, {
                                  className: 'w-4 h-4',
                                }),
                              }),
                            ],
                      ...
                      children: (0, c.jsxs)('div', {
                        ...
                        children: [
                          v
                            ...
                            : (0, c.jsx)('div', {
                                className:
                                  'w-full h-full bg-gradient-to-br from-[#e0e7ff] to-[#f4f7ff] animate-pulse',
                              }),
                          (0, c.jsx)('div', {
                            ...
                            children: (0, c.jsx)('button', {
                              ...
                              onClick: () => {
                                let a = !x;
                                (A(a ? 'muted' : 'unmuted'), B(a));
                              },
                              className:
                                'inline-flex items-center justify-center w-12 h-12 rounded-full bg-white/85 text-[#0057FF] text-xl shadow-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white',
                              'aria-label': x
