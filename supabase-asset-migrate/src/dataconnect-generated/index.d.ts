...
interface CreateUserRef {
  ...
  ): MutationRef<CreateUserData, CreateUserVariables>;
...
interface GetProjectsByUserRef {
  ...
  ): QueryRef<GetProjectsByUserData, GetProjectsByUserVariables>;
  /* Allow users to pass in custom DataConnect instances */
  (
    dc: DataConnect,
    vars: GetProjectsByUserVariables
...
export function getProjectsByUser(
  vars: GetProjectsByUserVariables
): QueryPromise<GetProjectsByUserData, GetProjectsByUserVariables>;
export function getProjectsByUser(
  dc: DataConnect,
  vars: GetProjectsByUserVariables
): QueryPromise<GetProjectsByUserData, GetProjectsByUserVariables>;
...
interface CreateProjectRef {
  ...
  ): MutationRef<CreateProjectData, CreateProjectVariables>;
  /* Allow users to pass in custom DataConnect instances */
  (
    dc: DataConnect,
    vars: CreateProjectVariables
...
export function createProject(
  vars: CreateProjectVariables
): MutationPromise<CreateProjectData, CreateProjectVariables>;
export function createProject(
  dc: DataConnect,
  vars: CreateProjectVariables
): MutationPromise<CreateProjectData, CreateProjectVariables>;
...
interface DeleteProjectRef {
  ...
  ): MutationRef<DeleteProjectData, DeleteProjectVariables>;
  /* Allow users to pass in custom DataConnect instances */
  (
    dc: DataConnect,
    vars: DeleteProjectVariables
...
export function deleteProject(
  vars: DeleteProjectVariables
): MutationPromise<DeleteProjectData, DeleteProjectVariables>;
export function deleteProject(
  dc: DataConnect,
  vars: DeleteProjectVariables
): MutationPromise<DeleteProjectData, DeleteProjectVariables>;
