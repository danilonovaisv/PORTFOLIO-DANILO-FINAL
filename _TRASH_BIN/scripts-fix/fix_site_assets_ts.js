...
content = content.replace(
  "'global.favicon_light'",
  "'global.logos.global.favicon_light'"
);
content = content.replace(
  "'global.favicon_dark'",
  "'global.logos.global.favicon_dark'"
);

// Replace fonts
content = content.replace(
  "'global.font_display'",
  "'global.fonts.global.font_display'"
);
...
content = content.replace(
  "'global.font_body'",
  "'global.fonts.global.font_body'"
);
content = content.replace(
  "'global.font_light'",
  "'global.fonts.global.font_light'"
);

// Replace heroVideos home
content = content.replace(
  "'home.manifesto_video'",
  "'home.video.manifesto.desk'"
);
content = content.replace(
  "'home.manifesto_video_mobile'",
  "'home.video.manifesto.mobile'"
);

// Replace about hero
content = content.replace(
  "'about.hero.desktop_video.mp4'",
  "'about.hero.about.hero.desktop_video'"
);
content = content.replace(
  "'about.hero.mobile_video.mp4'",
  "'about.hero.about.hero.mobile_video'"
);

// Replace portfolio hero
content = content.replace(
  "'portfolio.hero_desktop_video'",
  "'portfolio.hero.portfolio.hero_desktop_video'"
);
content = content.replace(
  "'portfolio.hero_mobile_video'",
  "'portfolio.hero.portfolio.hero_mobile_video'"
);
...
content = content
  ...
  .map((line) => {
    if (line.includes('method:') && line.includes("'about.method_video'")) {
      return line.replace(
        "'about.method_video'",
        "'about.method.about.method.desktop_video'"
      );
    }
    if (
      line.includes('methodDesktop:') &&
      line.includes("'about.method_video'")
    ) {
      return line.replace(
        "'about.method_video'",
        "'about.method.about.method.desktop_video'"
    ...
    if (
      line.includes('methodMobile:') &&
      line.includes("'about.method_video'")
    ) {
      return line.replace(
        "'about.method_video'",
        "'about.method.about.method.mobile_video'"
      );
    }
    return line;
  })
