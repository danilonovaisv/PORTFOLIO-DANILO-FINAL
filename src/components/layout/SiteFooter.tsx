        ...
        >
          {NAVIGATION.footer.links.map((link) => (
            <Link
              key={link.label}
              href={link.href}
              className="group relative text-[11px] sm:text-[12px] font-bold uppercase tracking-widest hover:opacity-80 transition-opacity duration-200 py-3 lg:py-2 flex items-center shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-bluePrimary rounded-sm"
            >
              {link.label}
        ...
        >
          {socialLinks.map((social) => (
            <a
              ...
              className="transition-transform duration-200 opacity-100 lg:opacity-90 lg:hover:opacity-100 p-3 lg:p-0 flex items-center justify-center min-w-[48px] min-h-[48px] lg:min-w-0 lg:min-h-0 hover:-translate-y-0.5 will-change-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-bluePrimary rounded-md"
              aria-label={`${social.label} (Abre em uma nova aba)`}
            >
              {social.icon}
              <span className="sr-only">{`${social.label} (Abre em uma nova aba)`}</span>
            </a>
          ))}
        </nav>
      </div>
