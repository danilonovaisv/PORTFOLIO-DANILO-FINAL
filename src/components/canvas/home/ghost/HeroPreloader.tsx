...
const HeroPreloader = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (progressBarRef.current) {
        const width = parseFloat(progressBarRef.current.style.width) || 0;
        if (width < 100) {
          progressBarRef.current.style.width = `${width + 1}%`;
        }
      }
    }, 50);
  ...
  return (
    <div className="fixed inset-0 bg-black z-50 flex flex-col items-center justify-center">
      <div className="preloader-content text-white text-center">
