...
export const analogDecayVertexShader = `
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
export const analogDecayFragmentShader = `
...
export const analogDecayShader = {
  ...
  vertexShader: analogDecayVertexShader,
  fragmentShader: analogDecayFragmentShader,
};
