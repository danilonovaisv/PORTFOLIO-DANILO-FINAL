...
export function BeliefScrollText() {
  ...
  useMotionValueEvent(phraseProgress, 'change', (latest) => {
    ...
    if (rounded !== activeIndex && rounded >= 0 && rounded < BELIEF_PHRASES.length) {
  ...
  return (
    <div data-testid="beliefs-scroll-text" className="pointer-events-none fixed inset-0 z-[var(--z-layer-cta)] flex flex-col justify-end pb-[20vh] md:justify-center md:pb-0">
