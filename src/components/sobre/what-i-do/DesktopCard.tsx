  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#204fff] text-white transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(168,85,247,0.5)] group-hover:scale-110">
