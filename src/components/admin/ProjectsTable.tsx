                                ...
                                <div className="flex flex-col gap-1 text-xs">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <form action={toggleFeaturedOnHome}>
                                            ...
                                            <button
                                                type="submit"
                                                className={`rounded px-2 py-1 text-xs font-semibold ${project.featured_on_home
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <form action={toggleFeaturedOnPortfolio}>
                                            ...
                                            <button
                                                type="submit"
                                                className={`rounded px-2 py-1 text-xs font-semibold ${project.featured_on_portfolio
