// Hero.tsx
'use client'; // Certifique-se de que 'use client' está no topo

import React, { useRef, useState, useEffect } from 'react'; // Adicione useState e useEffect
import {
    motion,
    useScroll,
    useTransform,
    useMotionValueEvent,
    useReducedMotion, // Adicione useReducedMotion
} from 'framer-motion';
import { ArrowRight } from 'lucide-react'; // Adicione ArrowRight
import { ASSETS } from '../../lib/constants'; // Adicione ASSETS
import HeroGlassScene from '../../components/three/HeroGlassScene'; // Adicione HeroGlassScene
...
const Hero: React.FC = () => {
    const sectionRef = useRef<HTMLElement>(null); // Mantenha este useRef
    const videoRef = useRef<HTMLVideoElement>(null); // Mantenha este useRef
