    ...
    useEffect(() => {
      ...
      `,
        ...
        void main() {
          ...
          if (uAnalogJitter > 0.01) {
            jitteredUV.x += (random(vec2(floor(uTime * 30.0))) - 0.5) * 0.001 * uAnalogJitter * uAnalogIntensity;
            jitteredUV.y += (random(vec2(floor(uTime * 30.0) + 1.0)) - 0.5) * 0.001 * uAnalogJitter * uAnalogIntensity;
          }

          // Rolagem VHS
          if (uAnalogVSync > 0.01) {
            float vsyncRoll = sin(uTime * 2.0 + uv.y * 100.0) * 0.02 * uAnalogVSync * uAnalogIntensity;
          ...
          if (uAnalogGrain > 0.01) {
            vec3 grainEffect = grain(uv, uTime, 0.075 * uAnalogGrain * uAnalogIntensity);
      ...
      `
        ...
        const ghostMaterial = new THREE.MeshStandardMaterial({
            ...
            emissive: fluorescentColors[params.glowColor as keyof typeof fluorescentColors] || 0x000000,
        ...
        function createEyes() {
            ...
            const eyeMaterial = new THREE.MeshStandardMaterial({
                color: fluorescentColors[params.eyeGlowColor as keyof typeof fluorescentColors] || 0x000000,
                emissive: fluorescentColors[params.eyeGlowColor as keyof typeof fluorescentColors] || 0x000000,
        ...
        const particleMaterial = new THREE.MeshBasicMaterial({
            color: fluorescentColors[params.particleColor as keyof typeof fluorescentColors] || 0x000000,
            transparent: true,
            opacity: 0.8
        });
        ...
        function updateParticles(deltaTime: number) {
            particles.forEach((particle, index) => {
                if (particle.userData.velocity) {
                    ...
                    // Reduzir opacidade
                    (particle.material as THREE.MeshBasicMaterial).opacity -= params.particleDecayRate * deltaTime;
            ...
            if (params.createParticlesOnlyWhenMoving) {
