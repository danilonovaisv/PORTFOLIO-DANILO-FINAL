...
const SpectralGhost: React.FC<SpectralGhostProps> = ({ onLoaded }) => {
    ...
    useEffect(() => {
        ...
        // Adicionar o canvas ao DOM (IMPORTANTE!)
        // Remova esta linha se já estiver usando o canvasRef
      ...
      `
        ...
        // Partículas
        const particles: THREE.Mesh<THREE.BufferGeometry, THREE.MeshBasicMaterial>[] = [];
