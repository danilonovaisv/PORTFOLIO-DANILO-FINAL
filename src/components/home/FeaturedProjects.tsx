      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-[92%] xl:max-w-420 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16 md:gap-y-20">
          ...
          <motion.div
            ...
            className="flex flex-col justify-center items-center text-center min-h-[300px] md:min-h-auto p-8 md:p-0 rounded-2xl bg-white/5 md:bg-transparent border border-white/10 md:border-none"
          >
            <h3 className="text-3xl md:text-5xl font-bold font-sans tracking-tight text-[#F0F0F0] mb-8 leading-tight">
              Like what
              <br />
              you see?
            </h3>
