...
const ENTRY_ANIMATION = {
  ...
  transition: {
    ...
    delay: 0.1, // Small delay after preloader would have started fading
  },
};
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial={prefersReducedMotion ? {} : (ENTRY_ANIMATION.initial as any)}
        animate={!prefersReducedMotion ? (ENTRY_ANIMATION.animate as any) : {}}
        transition={ENTRY_ANIMATION.transition as any}
      >
        ...
        {/* Z-20: Hero Copy (Editorial Text Block) */}
        <motion.div
        ...
        {/* Z-30: WebGL Ghost Atmosphere - Above Ghost */}
