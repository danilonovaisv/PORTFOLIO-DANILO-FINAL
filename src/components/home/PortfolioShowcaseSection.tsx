      ...
      <div className="max-w-[1680px] mx-auto px-[clamp(24px,5vw,96px)] relative">
        ...
        <div className="relative mb-20 flex flex-col items-center justify-center">
          <motion.h2
            ...
            className="text-4xl md:text-6xl font-bold text-center text-text-dark"
          >
            portfólio showcase
          </motion.h2>
        ...
        {/* List */}
        <div className="flex flex-col border-b border-[#0057FF]/30">
          {ITEMS.map((item) => (
            <Link
              key={item.id}
              href={item.href}
              className="group flex w-full border-t border-[#0057FF]/30 py-8 md:py-14 items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0057FF] rounded-md transition-colors"
            >
