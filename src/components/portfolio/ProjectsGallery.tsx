...
export const ProjectsGallery = ({
  ...
  const getTrackClasses = () => {
    ...
    switch (scrollState) {
      case 'fixed':
        return 'fixed left-0 right-0 z-10 max-w-[1680px] mx-auto px-6 md:px-16';
      case 'post':
              ...
              {totalPages > 1 && (
                <div className="col-span-full mt-16 mb-8 flex justify-center items-center gap-6">
                  <button
                    ...
                    aria-controls="portfolio-filter-panel"
                    className="relative group px-6 py-3 font-display font-medium text-sm tracking-widest uppercase transition-all duration-fast disabled:opacity-30 disabled:cursor-not-allowed hover:text-blueAccent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blueAccent/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                  >
