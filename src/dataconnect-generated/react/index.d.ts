import {
  CreateUserData,
  CreateUserVariables,
  GetProjectsByUserData,
  GetProjectsByUserVariables,
  CreateProjectData,
...
export function useGetProjectsByUser(
  ...
  options?: useDataConnectQueryOptions<GetProjectsByUserData>
): UseDataConnectQueryResult<GetProjectsByUserData, GetProjectsByUserVariables>;
export function useGetProjectsByUser(
  dc: DataConnect,
  vars: GetProjectsByUserVariables,
  options?: useDataConnectQueryOptions<GetProjectsByUserData>
...
export function useCreateProject(
  options?: useDataConnectMutationOptions<
    ...
    CreateProjectVariables
  >
): UseDataConnectMutationResult<CreateProjectData, CreateProjectVariables>;
export function useCreateProject(
  dc: DataConnect,
  options?: useDataConnectMutationOptions<
    CreateProjectData,
...
export function useDeleteProject(
  options?: useDataConnectMutationOptions<
    ...
    DeleteProjectVariables
  >
): UseDataConnectMutationResult<DeleteProjectData, DeleteProjectVariables>;
export function useDeleteProject(
  dc: DataConnect,
  options?: useDataConnectMutationOptions<
    DeleteProjectData,
