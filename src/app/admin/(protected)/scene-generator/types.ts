...
export const SCENE_CATEGORIES = [
  {
    ...
    sub_options: [
      ...
      { label: "Notebook em cafeteria com reflexo urbano", value: "notebook_cafeteria_reflexo" },
  ...
  },
  {
    ...
    sub_options: [
      ...
      { label: "Selfie com celular mostrando post", value: "selfie_celular_mostrando_post" },
      { label: "Grupo de amigos vendo tela do celular", value: "grupo_amigos_vendo_celular" },
      { label: "Pessoa em café olhando Instagram", value: "pessoa_cafe_instagram" },
      ...
      { label: "Pessoa mostrando post para atendente", value: "pessoa_mostrando_post_loja" },
  ...
  },
  {
    ...
    sub_options: [
      ...
      { label: "Planner com anúncio aplicado", value: "planner_anuncio_aplicado" },
      { label: "Sketchbook com layout impresso", value: "sketchbook_layout_impresso" },
