export default function Loading() {
  return (
    <main
      className="relative min-h-screen w-full overflow-hidden bg-[#040013] text-white"
      aria-label="Carregando O Que Me Move"
      aria-busy="true"
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(79,230,255,0.14),transparent_34%),linear-gradient(180deg,#040013_0%,#0b0d3a_100%)]" />
