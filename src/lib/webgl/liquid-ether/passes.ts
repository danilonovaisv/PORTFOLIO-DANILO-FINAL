...
export class Advection extends ShaderPass {
    ...
    update(params: { dt?: number; isBounce?: boolean; BFECC?: boolean } = {}) {
        ...
        if (typeof params.isBounce === 'boolean') this.line.visible = params.isBounce;
        if (typeof params.BFECC === 'boolean') this.uniforms.isBFECC.value = params.BFECC;
        super.update();
    }
}
...
export class Viscous extends ShaderPass {
    ...
    update(params: { viscous?: number; iterations?: number; dt?: number } = {}) {
        ...
        if (typeof params.viscous === 'number') this.uniforms.v.value = params.viscous;
