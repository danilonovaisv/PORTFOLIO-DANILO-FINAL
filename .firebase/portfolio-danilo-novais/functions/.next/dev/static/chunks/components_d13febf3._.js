...
const TorusDan = ({ reduceMotion = false })=>{
    ...
    const { scene } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$three$2f$drei$2f$core$2f$Gltf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGLTF"])('/media/torus_dan.glb');
    const glassScene = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TorusDan.useMemo[glassScene]": ()=>{
            const clone = scene.clone(true);
            clone.traverse({
                "TorusDan.useMemo[glassScene]": (child)=>{
                    if (child.isMesh) {
                        const mesh = child;
                        mesh.material = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshPhysicalMaterial"]({
                            transmission: 1,
                            roughness: 0.05,
                            clearcoat: 1,
                            ...
                            thickness: 0.85,
                            ior: 1.2,
                            attenuationColor: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]('#f4f5f7'),
...
_s(TorusDan, "kBgx7OgaSQtXZuWksjgGlx3DXXY=", false, function() {
    return [
