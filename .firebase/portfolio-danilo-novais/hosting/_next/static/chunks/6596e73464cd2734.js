(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var m = e.i(37806),
      ...
      u = e.i(95420);
    function h(e, t = {}) {
      let { isStatic: i } = (0, a.useContext)(m.MotionConfigContext),
        s = () => ((0, o.isMotionValue)(e) ? e.get() : e);
      if (i) return (0, u.useTransform)(s);
      let l = (0, x.useMotionValue)(s());
      return (
          ...
          () =>
            (function (e, t, i) {
              let a,
                ...
                l = null,
                r = s,
                m = 'string' == typeof s ? s.replace(/[\d.-]/g, '') : void 0,
                x = () => {
                  l && (l.stop(), (l = null));
                },
                u = () => {
              ...
              if (
                (e.attach((e, t) => {
                  ((r = e),
                    (a = (e) => {
                      var i, a;
                      return t(((i = e), (a = m) ? i + a : i));
                    }),
                    c.frame.postRender(u));
                }, x),
                (0, o.isMotionValue)(t))
              ) {
                let i = t.on('change', (t) => {
    ...
    e.s(
      [
        ...
        () => {
          ...
          let t = (0, a.useRef)(null),
            n = (0, a.useRef)(null),
            o = (function () {
              f.hasReducedMotionListener.current ||
                (0, p.initPrefersReducedMotion)();
              let [e] = (0, a.useState)(f.prefersReducedMotion.current);
              return e;
            })(),
            [c, d] = (0, a.useState)(!1),
            [m, x] = (0, a.useState)(!1),
            [v, j] = (0, a.useState)(!1),
            [N, F] = (0, a.useState)(!0),
            [k, T] = (0, a.useState)(null);
          ((0, a.useEffect)(() => {
            let e = setTimeout(() => d(!0), 100);
            return () => clearTimeout(e);
          }, []),
            (0, a.useEffect)(() => {
              let e = () => {
                x(!o && window.innerWidth >= 1024);
              };
              return (
                e(),
          ...
          ((e = (e) => {
            e <= 0.01 || e >= 0.92 ? A(!0, !0) : null === k && A(!1);
          }),
            (0, a.useInsertionEffect)(
              () => S.on('change', e),
              [S, 'change', e]
            ));
          let R = (0, u.useTransform)(S, [0, 0.15], [1, +!!o]),
            C = (0, u.useTransform)(S, [0, 0.15], [1, o ? 1 : 0.95]),
            E = (0, u.useTransform)(S, [0, 0.15], [0, o ? 0 : -50]),
            M = (0, u.useTransform)(S, [0, 0.25], [0.25, o ? 0.9 : 1]),
            $ = (0, u.useTransform)(S, [0, 0.25], ['35%', '0%']),
            z = (0, u.useTransform)(S, [0, 0.25], ['30%', '0%']),
            I = (0, u.useTransform)(S, [0, 0.2], [o ? 4 : 12, 0]),
            O = h(0, { stiffness: 110, damping: 18 }),
            L = h(0, { stiffness: 110, damping: 18 }),
            V = h(0, { stiffness: 110, damping: 18 }),
            U = h(0, { stiffness: 110, damping: 18 }),
            _ = { opacity: 0, y: 32 },
            q = { opacity: 0, y: 32 },
            P = { opacity: 0, y: 32 },
            D = (0, a.useMemo)(
      ...
      `,
              ...
              (0, i.jsxs)(l.motion.div, {
                ...
                onMouseLeave: () => {
                  (O.set(0), L.set(0), V.set(0), U.set(0));
                },
                children: [
                  (0, i.jsx)(l.motion.div, {
                    style: { opacity: R, scale: C, y: E },
                    className: D,
                    children: (0, i.jsxs)(l.motion.div, {
                      style: { x: O, y: L },
                      className:
                        'flex flex-col justify-center items-start h-full pt-24 md:pt-0 max-w-3xl gap-8 lg:gap-10 pointer-events-auto px-2 sm:px-4',
                      children: [
                        (0, i.jsxs)(l.motion.h1, {
                          initial: _,
                          animate: c ? { opacity: 1, y: 0 } : _,
                          transition: { duration: 0.65, ease: w, delay: 0.2 },
                        ...
                        (0, i.jsx)(l.motion.div, {
                          initial: q,
                          animate: c ? { opacity: 1, y: 0 } : q,
                          transition: { duration: 0.65, ease: w, delay: 0.35 },
                        ...
                        (0, i.jsx)(l.motion.div, {
                          initial: P,
                          animate: c ? { opacity: 1, y: 0 } : P,
                          transition: { duration: 0.65, ease: w, delay: 0.5 },
                          className: 'pointer-events-auto',
                          children: (0, i.jsxs)(l.motion.a, {
                            href: '/sobre',
                            whileHover: {
                              scale: 1.04,
                              boxShadow:
                  ...
                  (0, i.jsx)(l.motion.div, {
                    style: { scale: M, x: $, y: z, borderRadius: I },
                    className:
                ...
                children: (0, t.jsx)(s.AnimatePresence, {
                  ...
                  children: l.CATEGORIES.map((i, l) => {
                    let m = c === i.id,
                      ...
                      p = 'websites-webcampaigns-tech' === i.id;
                    return x
                      ? null
                      : (0, t.jsxs)(
                          a.motion.div,
                      ...
                      children: (0, t.jsx)('img', {
                        ...
                        onError: (e) => {
                          ((e.currentTarget.style.display = 'none'),
                            (e.currentTarget.parentElement.innerHTML = `<div class="text-white font-bold text-xl opacity-50">CLIENT ${a + 1}</div>`));
                        },
                      }),
                    },
                    a
