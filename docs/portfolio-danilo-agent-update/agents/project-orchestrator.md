...
## Routing
- Admin auth/CRUD/upload/publishing -> Admin Reliability
- Cards/video/HTML/responsive UI -> Portfolio Experience
- Project case page -> Portfolio Experience
- Supabase schema/RLS/storage policy -> Database Sentinel
- Three.js/shader/rendering -> existing visual/shader specialist
- Any implemented change -> Quality Verification
