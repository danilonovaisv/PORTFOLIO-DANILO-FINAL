...
| T1 | concluída | ≤1h | T0 | nextjs-architecture-expert | Fixar toolchain em Node 22 + TypeScript 6.0.2 e regenerar lockfile com pnpm. | Instalação reproduzível com lockfile congelado; versões reais confirmadas. |
