        ...
        >
           ...
           >
              ...
              <div className="absolute top-6 right-6 md:top-10 md:right-10 z-50 transition-opacity duration-300">
                 <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg animate-pulse hover:animate-none hover:scale-110 transition-transform cursor-pointer" role="button" aria-label="Reproduzir vídeo">
