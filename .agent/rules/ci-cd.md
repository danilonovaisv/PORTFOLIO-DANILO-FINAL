...
- ✅ Sem essa flag experimental do Firebase CLI, os deploys de Next.js (App Router) falharão em ambientes headless ou de CI/CD que não suportam *prompts* interativos, gerando `exit code 1`.
