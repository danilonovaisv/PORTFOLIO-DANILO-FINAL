...
### 🛡️ 02. Rule de Verificação Contínua (`.agent/rules/asset-integrity.md`)

Esta regra garante que o agente nunca "quebre" os links ou invente dados falsos ao editar componentes.

**Caminho:** `.agent/rules/asset-integrity.md`

```markdown
# Regra: Integridade de Assets e Dados Globais

**Prioridade:** CRÍTICA (Verificar em TODA alteração de UI)
