...
Deno.serve(async (req) => {
  try {
    ...
    // If not dry run, you may want to log or audit deletions asynchronously
    // Use EdgeRuntime.waitUntil(...) in environments that support it for background tasks
    return new Response(
      JSON.stringify({
        dry_run: dryRun,
