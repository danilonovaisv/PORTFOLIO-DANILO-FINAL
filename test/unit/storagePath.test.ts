...
describe('storagePath generator', () => {
    ...
    describe('normalizeProject', () => {
        it('normalizes project name to slug', () => {
            expect(normalizeProject('Campanha Verão 2024')).toBe('campanha-ver-o-2024');
        });
    });
    ...
    describe('buildV4Path', () => {
        it('builds a correct path without kind', () => {
            ...
            expect(path).toBe('v4/o-botic-rio/boti-sun/video-final-01.abcdef1234567890.mp4');
        });
        ...
        it('builds a correct path with kind', () => {
            ...
            expect(path).toBe('v4/danilo/rebranding/cover-16x9/imagem.1234567890abcdef.png');
        });
