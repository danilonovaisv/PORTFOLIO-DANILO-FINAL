...
This project is configured with **specialized AI skills** and intelligent agent routing.
...
- ✅ Load specialized Ghost System skills
...
- **Concepts**: See `CONCEPTS.md` for Rule/Skill/Workflow definitions
