...
description: Teams-First Multi-Agent Orchestrator para coordenação paralela, swarm e pipelines especializados.
skills: orchestration, parallel-agents, plan-writing
---
