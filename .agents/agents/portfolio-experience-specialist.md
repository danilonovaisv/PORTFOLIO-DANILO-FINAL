...
description: Frontend experience specialist for Home, Portfolio, project media cards (video/HTML/image), and /projects/[slug] case pages.
skills: review-project-media-card, review-project-case-page, verify-portfolio-change, clean-code, tailwind-patterns
...
- shader internals already owned by the visual specialist (Spectral Artist).
