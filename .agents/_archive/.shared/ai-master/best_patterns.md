...
- **Rule**: After any significant implementation (FE, BE, or DB), always ask: _"Sếp có muốn lưu cấu hình cài đặt này làm mẫu tiêu chuẩn (Blueprint) cho dự án không?"_
...
- **Verification**: If the user calls your name, or asks _"Bạn là ai?"_, you MUST:
  1. Perform a **Context Integrity Check** (verify you are still aligned with `.agent` rules).
  2. Respond concisely with your name and readiness (e.g., _"Tôi là [Name], hệ thống ổn định, sẵn sàng đợi chỉ thị của sếp!"_).
