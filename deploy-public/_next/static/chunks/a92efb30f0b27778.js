(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var t = e.i(96148),
      i = e.i(84833),
      a = e.i(73019);
    let r = (0, e.i(16424).default)('arrow-up-right', [
      ['path', { d: 'M7 7h10v10', key: '1tivn9' }],
      ['path', { d: 'M7 17 17 7', key: '1vkiza' }],
    ]);
    (e.s(['ArrowUpRight', () => r], 45439),
      e.s(
        [
          'default',
          0,
  ...
  (e) => {
    ...
    function D(e, { container: a = document.scrollingElement, ...r } = {}) {
      if (!a) return n.noop;
      let o = R.get(a);
      o || ((o = new Set()), R.set(a, o));
      let l = (function (e, t, i, a = {}) {
        return {
          measure: (t) => {
            (!(function (e, t = e, i) {
      ...
      })(a, e, { time: 0, x: w(), y: w() }, r);
      if ((o.add(l), !T.has(a))) {
        let e,
          r = () => {
            for (let e of o) e.measure(s.frameData.timestamp);
            s.frame.preUpdate(n);
          },
          n = () => {
              ...
              'function' == typeof a
                ...
                : (!t &&
                  ...
                  () => {
                    e.forEach((e) => {
                      let i = u.get(e);
                      (i?.delete(l), i?.size || t?.unobserve(e));
                    });
                  })
            ),
      ...
      return (
        ...
        () => {
          ...
          (T.delete(a),
            t &&
              (F(a).removeEventListener('scroll', t),
              q.get(a)?.(),
    ...
    let B = () => ({
      ...
      P = (e) => !!e && !e.current;
    function H({ container: e, target: t, ...i } = {}) {
      let a = (0, _.useConstant)(B),
        s = (0, o.useRef)(null),
        c = (0, o.useRef)(!1),
        d = (0, o.useCallback)(
          () => (
      ...
      return (
        (0, W.useIsomorphicLayoutEffect)(() => {
          if (((c.current = !1), !(P(e) || P(t)))) return d();
          c.current = !0;
        }, [d]),
        (0, o.useEffect)(
          () =>
        ...
        children: (0, t.jsx)(w.Container, {
          children: (0, t.jsxs)('div', {
            ...
            children: [
              ...
              (0, t.jsx)('div', {
                className:
                  'lg:hidden flex flex-wrap justify-center gap-4 py-8 border-t border-[#0e0e0e]/20 w-full order-3',
                children: n.map((e) =>
                  (0, t.jsx)(
                    'a',
                    {
