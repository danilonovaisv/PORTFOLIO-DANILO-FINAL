    ...
    e.s([
      ...
      () => {
        let e = (0, i.useRef)(null),
          ...
          p = (0, i.useRef)(0),
          [f, h] = (0, i.useState)(!1),
          g = (e) => (0, c.buildSupabaseStorageUrl)('site-assets', e) ?? void 0,
          b =
            (0, o.useSiteAssetUrl)(
        ...
        (0, i.useEffect)(() => {
          ...
          u.current = e;
          let t = (i) => {
            (e.raf(i), (p.current = requestAnimationFrame(t)));
          };
          ((p.current = requestAnimationFrame(t)),
            e.on('scroll', l.ScrollTrigger.update));
          let i = s.default.matchMedia();
          (i.add('(min-width: 1024px)', () => {
            ...
            (s.default.set(t, {
              ...
              e.forEach((e, t) => {
                e.style.zIndex = (w.length - t).toString();
              }),
              s.default.to(t[0], {
                filter: 'blur(0px)',
                opacity: 1,
              ...
              w.forEach((i, r) => {
                let o = e[r],
                  ...
                  c = t[r + 1];
                if (r < w.length - 1) {
                  let e = s.default.timeline({ paused: !0 });
                  (e
                    .to(
                      'body',
                      {
    ...
    let c = ({
        ...
        return l
          ? (0, t.jsxs)('article', {
              ...
              'aria-label': i,
              className:
                'card-shell group relative flex flex-row items-center text-white outline-none bg-[#0048ff] w-[260px] shrink-0 rounded-[16px] px-5 py-5 gap-4 focus-visible:ring-2 focus-visible:ring-[#4fe6ff]',
              children: [
                (0, t.jsx)('div', {
                  className:
          ...
          : (0, t.jsxs)(a.motion.article, {
              ...
              'aria-label': i,
              className:
                'card-shell group relative flex flex-row items-center text-white outline-none will-change-transform bg-[#0048ff] w-[260px] shrink-0 rounded-[16px] px-5 py-5 gap-4 hover:brightness-110 focus-visible:ring-2 focus-visible:ring-[#4fe6ff]',
              style: {
                x: x,
                opacity: u,
      ...
      d = ({ index: e, text: i, prefersReducedMotion: s }) => {
        ...
        return (0, t.jsxs)(a.motion.article, {
          ...
          className:
            'card-shell group relative flex flex-col items-center justify-center text-center text-white outline-none bg-[#0048ff] w-full h-auto py-6 rounded-[12px] px-6 gap-2 hover:brightness-110 focus-visible:ring-2 focus-visible:ring-[#4fe6ff]',
          children: [
            (0, t.jsx)('div', {
              className:
    ...
    function o() {
      ...
      return (0, t.jsx)('section', {
        ...
        children: (0, t.jsxs)(i.motion.div, {
          ...
          className:
            'mx-auto flex w-full max-w-[1000px] flex-col items-center text-center',
          children: [
            (0, t.jsxs)('div', {
              className: 'w-full',
              children: [
            ...
            (0, t.jsxs)('div', {
              ...
              children: [
                (0, t.jsxs)('p', {
                  className:
                    'type-h2 text-text opacity-90 max-w-[800px] leading-snug',
                  children: [
                ...
                (0, t.jsx)('div', {
                  className:
                    'mt-12 w-full max-w-[800px] overflow-hidden rounded-xl shadow-2xl md:mt-11',
