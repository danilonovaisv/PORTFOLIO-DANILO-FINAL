(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function eu(e, t, n) {
      var r, i, l, o, s, u, c, f, d;
      let p, g, y, x, v, k, b, w, S, C, E;
                          ...
                          : (function (e, t) {
                              try {
                                ...
                                throw (
                                  ...
                                  (t.url =
                                    es + '#cannot-parse-style-attribute'),
                                  t
                                );
                              }
                            })(e, String(n));
        ...
        : 'mdxFlowExpression' === t.type || 'mdxTextExpression' === t.type
          ...
          : 'mdxJsxFlowElement' === t.type || 'mdxJsxTextElement' === t.type
            ? ((o = e),
              ...
              (u = n),
              (b = k = o.schema),
              'svg' === s.name && 'html' === k.space && (o.schema = K),
              o.ancestors.push(s),
              (w = null === s.name ? o.Fragment : ep(o, s.name, !0)),
              (S = (function (e, t) {
                let n = {};
                for (let r of t.attributes)
                  if ('mdxJsxExpressionAttribute' === r.type)
                    if (r.data && r.data.estree && e.evaluater) {
                      ...
                      a('ExpressionStatement' === t.type);
                      let i = t.expression;
                      a('ObjectExpression' === i.type);
                      let l = i.properties[0];
                      (a('SpreadElement' === l.type),
                        Object.assign(
                          n,
    ...
    function eM(e, t, n, r) {
      ...
      return function (r) {
        return ej(r)
          ? (e.enter(n),
            (function r(o) {
              return ej(o) && l++ < i ? (e.consume(o), r) : (e.exit(n), t(o));
            })(r))
          : t(r);
      };
    }
    let eF = {
        ...
        tokenize: function (e) {
          ...
          function s(e) {
            if ((o++, i.containerState._closeFlow)) {
              ...
              return (
                ek(i.events, l + 1, 0, i.events.slice(r)),
                (i.events.length = a),
                u(e)
              );
            }
          ...
          function u(n) {
            ...
            return ((i.containerState = {}), e.check(e_, c, f)(n));
          }
          function c(e) {
            return (t && y(), g(o), d(e));
          }
          ...
          function d(t) {
            return ((i.containerState = {}), e.attempt(e_, p, h)(t));
          }
          function p(e) {
          ...
          function m(e, l) {
            ...
            if (
              ...
              (ek(i.events, s + 1, 0, i.events.slice(a)),
                (i.events.length = l));
            }
          }
          function g(t) {
      ...
      eB = {
        ...
        tokenize: function (e, t, n) {
          return function (t) {
            return ej(t) ? eM(e, r, 'linePrefix')(t) : r(t);
          };
          function r(e) {
    ...
    class eU {
      ...
      splice(e, t, n) {
        ...
        return (n && eH(this.left, n), r.reverse());
      }
      pop() {
      ...
      pushMany(e) {
        (this.setCursor(1 / 0), eH(this.left, e));
      }
      unshift(e) {
        (this.setCursor(0), this.right.push(e));
      }
      unshiftMany(e) {
        (this.setCursor(0), eH(this.right, e.reverse()));
      }
      setCursor(e) {
        if (
          e !== this.left.length &&
    ...
    function eJ(e) {
      return {
        resolveAll: eY('text' === e ? eZ : void 0),
        tokenize: function (t) {
          let n = this,
    ...
    function eG(e) {
      return null === e || eL(e) || ez(e) ? 1 : eN(e) ? 2 : void 0;
    }
    function e0(e, t, n) {
      let r = [],
        i = -1;
    ...
    let e9 = {
        ...
        tokenize: function (e, t, n) {
          ...
          function u(a) {
            if (59 === a && o) {
              ...
              return i !== eC || e5(l.sliceSerialize(r))
                ? (e.enter('characterReferenceMarker'),
                  e.consume(a),
                  e.exit('characterReferenceMarker'),
      ...
      e8 = {
        ...
        tokenize: function (e, t, n) {
          ...
          function s(l) {
            return null === l || eD(l)
              ? (e.exit('codeFencedFence'),
                i.interrupt ? t(l) : e.check(e7, c, h)(l))
          ...
          function d(t) {
            return o > 0 && ej(t) ? eM(e, p, 'linePrefix', o + 1)(t) : p(t);
          }
          function p(t) {
            return null === t || eD(t)
              ? e.check(e7, c, h)(t)
    ...
    let ta = {
        ...
        tokenize: function (e, t, n) {
          ...
          function i(t) {
            return ej(t) ? eM(e, l, 'whitespace')(t) : l(t);
          }
          function l(e) {
            return null === e || eD(e) ? t(e) : n(e);
          }
      ...
      td = {
        ...
        resolveTo: function (e, t) {
          ...
          return (
            ...
            (l = eb(l, [['exit', c, t], e[i - 2], e[i - 1], ['exit', u, t]])),
            (l = eb(l, e.slice(i + 1))),
            (l = eb(l, [['exit', s, t]])),
            ek(e, r, e.length, l),
            e
            ...
            return r
              ? r._inactive
                ...
                : ((i = l.parser.defined.includes(
                    to(l.sliceSerialize({ start: r.end, end: l.now() }))
                  )),
                  e.enter('labelEnd'),
                  e.enter('labelMarker'),
                  e.consume(t),
        ...
        tokenize: function (e, t, n) {
            ...
            if (
              ...
              if (
                ...
                return (
                  ...
                  42 === t || 45 === t ? e.check(tv, n, a)(t) : a(t)
                );
              if (!r.interrupt || 49 === t)
                return (
                  e.enter('listItemPrefix'),
          ...
          function a(t) {
            return (
              ...
              e.check(eB, r.interrupt ? n : s, e.attempt(tb, c, u))
            );
          }
          function s(e) {
      ...
      tb = {
        ...
        tokenize: function (e, t, n) {
          ...
          return eM(
            ...
            function (e) {
              let i = r.events[r.events.length - 1];
              return !ej(e) && i && 'listItemPrefixWhitespace' === i[1].type
                ? t(e)
                : n(e);
            },
        ...
        0,
        {
          91: {
            ...
            tokenize: function (e, t, n) {
              ...
              function s(t) {
                return e.attempt(ta, u, u)(t);
              }
              function u(t) {
                return ej(t) ? eM(e, c, 'whitespace')(t) : c(t);
              }
              function c(l) {
                return null === l || eD(l)
            ...
            tokenize: function (e, t, n) {
              ...
              function h(o) {
                if (null === o || 47 === o || 62 === o || eL(o)) {
                  let a = 47 === o,
                    u = l.toLowerCase();
                  return !a && !i && tu.includes(u)
                    ? ((r = 1), s.interrupt ? t(o) : C(o))
                    : ts.includes(l.toLowerCase())
                      ? ((r = 6), a)
                        ? (e.consume(o), m)
                        : s.interrupt
                          ? t(o)
                    ...
                    : 62 === t && 4 === r
                      ...
                      : 63 === t && 3 === r
                        ...
                        : 93 === t && 5 === r
                          ? (e.consume(t), L)
                          : eD(t) && (6 === r || 7 === r)
                            ? (e.exit('htmlFlowData'), e.check(tc, z, E)(t))
                            : null === t || eD(t)
                              ? (e.exit('htmlFlowData'), E(t))
                              : (e.consume(t), C);
              }
              function E(t) {
                return e.check(tf, P, z)(t);
              }
              function P(t) {
                return (
                  e.enter('lineEnding'),
              ...
              function D(t) {
                if (62 === t) {
                  let n = l.toLowerCase();
                  return tu.includes(n) ? (e.consume(t), N) : C(t);
                }
                return eS(t) && l.length < 8
            ...
            let t = {
              ...
              exit: {
                ...
                definitionLabelString: function (e) {
                  ...
                  ((n.label = t),
                    (n.identifier = to(this.sliceSerialize(e)).toLowerCase()));
                },
                ...
                labelText: function (e) {
                  ...
                  ((n.label = t.replace(tT, tA)),
                    (n.identifier = to(t).toLowerCase()));
                },
                lineEnding: function (e) {
                  let n = this.stack[this.stack.length - 1];
                  if (this.data.atHardBreak) {
                    ((n.children[n.children.length - 1].position.end = tD(
                      e.end
                    )),
            ...
            switch (t) {
              ...
              case 5: {
                let n = [],
                  i = o([t, n], e);
                for (let [t, i] of e)
                  (r || !(tR(tF(t)) || tR(tF(i)))) && n.push([a(t), a(i)]);
                return i;
              }
              case 6: {
                let n = [],
                  i = o([t, n], e);
                for (let t of e) (r || !tR(tF(t))) && n.push(a(t));
                return i;
              }
            }
            let { message: s } = e;
    ...
    function tU(e) {
      ...
      for (; ++n < e.length; ) {
        let l = e.charCodeAt(n),
          o = '';
        if (37 === l && eC(e.charCodeAt(n + 1)) && eC(e.charCodeAt(n + 2)))
          i = 2;
        else if (l < 128)
      ...
      table: function (e, t) {
        ...
        if (n.length > 0) {
          let r = {
            ...
            l = J(t.children[1]),
            o = X(t.children[t.children.length - 1]);
    ...
    function t4(e, t) {
      ...
      if (e && e.data) {
        ...
        ('string' == typeof t &&
          ...
          'element' === n.type && i && Object.assign(n.properties, tB(i)),
      ...
      let n,
        ...
        o =
          ...
          (l = {
            ...
            footnoteOrder: [],
            handlers: { ...tZ, ...n.handlers },
            one: function (e, t) {
              let n = e.type,
                r = l.handlers[n];
              if (t0.call(l.handlers, n) && r) return r(l, e, t);
              ...
              return (
                ...
                function (e, t) {
                  let n = t.data || {},
                    r =
                      'value' in t &&
                      !(t0.call(n, 'hProperties') || t0.call(n, 'hChildren'))
        ...
        u = (function (e) {
          let t =
              'string' == typeof e.options.clobberPrefix
                ? e.options.clobberPrefix
                : 'user-content-',
            n = e.options.footnoteBackContent || tH,
              ...
              children: [
                {
                  type: 'element',
                  tagName: l,
                  properties: { ...tB(o), id: 'footnote-label' },
    ...
    let nt = function (e, t) {
      ...
      ni = function (...e) {
        ...
        let n,
          ...
          l = -1;
        for (; ++l < e.length; )
          (nl(e[l]), e[l] && (i = void 0 === i ? e[l] : i + '/' + e[l]));
        return void 0 === i
          ? '.'
          : (nl((t = i)),
    ...
    let na = ['history', 'path', 'basename', 'stem', 'extname', 'dirname'];
    class ns {
      constructor(e) {
        let t, n;
        ((t = e
        ...
        for (n in t) na.includes(n) || (this[n] = t[n]);
      }
      get basename() {
      ...
      get stem() {
        return 'string' == typeof this.path
          ? nt(this.path, this.extname)
          : void 0;
      }
      set stem(e) {
        (nc(e, 'stem'),
          nu(e, 'stem'),
          (this.path = ni(this.dirname || '', e + (this.extname || ''))));
      }
      fail(e, t, n) {
    ...
    class nh extends nd {
      ...
      copy() {
        ...
        return (e.data((0, t8.default)(!0, {}, this.namespace)), e);
      }
      data(e, t) {
      ...
      parse(e) {
        ...
        return (ng('parse', n), n(String(t), t));
      }
      process(e, t) {
        let n = this;
        return (
          this.freeze(),
          ng('process', this.parser || this.Parser),
          ny('process', this.compiler || this.Compiler),
        ...
        function r(r, i) {
          ...
          function s(e, n) {
            e || !n
              ...
              : r
                ? r(n)
                : (a(t, '`done` is defined if `resolve` is not'), t(void 0, n));
          }
      ...
      processSync(e) {
        ...
        return (
          this.freeze(),
          ng('processSync', this.parser || this.Parser),
          ny('processSync', this.compiler || this.Compiler),
          this.process(e, function (e, r) {
            ((n = !0), t7(e), (t = r));
          }),
          nk('processSync', 'process', n),
          a(t, 'we either bailed on an error or have a tree'),
          t
        );
      }
      run(e, t, n) {
        ...
        function i(i, l) {
          ...
          r.run(e, o, function (t, r, o) {
            ...
            t
              ...
              : i
                ? i(s)
                : (a(n, '`done` is defined if `resolve` is not'),
                  n(void 0, s, o));
          });
        }
      }
      runSync(e, t) {
        ...
        return (
          ...
          nk('runSync', 'run', r),
          a(n, 'we either bailed on an error or have a tree'),
          n
        );
      }
      stringify(e, t) {
        ...
        return (ny('stringify', r), nv(e), r(e, n));
      }
      use(e, ...t) {
        ...
        function i(e) {
          ...
          (l(e.plugins),
            e.settings &&
              (r.settings = (0, t8.default)(!0, r.settings, e.settings)));
        }
        function l(e) {
          let t = -1;
          if (null == e);
        ...
        function o(e, t) {
          ...
          if (-1 === i) n.push([e, ...t]);
            ...
            let [r, ...l] = t,
              o = n[i][1];
            (ne(o) && ne(r) && (r = (0, t8.default)(!0, o, r)),
              (n[i] = [e, r, ...l]));
          }
        }
      }
    }
    let nm = new nh().freeze();
    function ng(e, t) {
    ...
    function nP(e) {
      ...
      let r,
        ...
        a,
        u =
          ((r = (n = e).rehypePlugins || nw),
          (i = n.remarkPlugins || nw),
          (l = n.remarkRehypeOptions
            ? { ...n.remarkRehypeOptions, ...nS }
            : nS),
          nm().use(tj).use(i).use(t9, l).use(r)),
        c =
          ((o = e.children || ''),
          (a = new ns()),
          'string' == typeof o
      ...
      let { type: l, content: o } = e,
        ...
        s = (e, n, r = '') => {
          ...
          let i = [
            ...
            l = {};
          return (
            n?.color && n.color.startsWith('#') && (l.color = n.color),
            (0, t.jsx)('div', {
              className: `prose prose-invert max-w-none ${r}`,
              style: l,
              children: (0, t.jsx)(nP, {
                components: {
                  p: ({ children: e }) =>
                  ...
                  ol: ({ children: e }) =>
                    (0, t.jsx)('ol', {
                      className: 'list-decimal pl-6 mb-4 space-y-2 text-left',
                      children: e,
                    }),
                  li: ({ children: e }) =>
                    (0, t.jsx)('li', { className: `${i} mb-1`, children: e }),
                  strong: ({ children: e }) =>
                    (0, t.jsx)('strong', {
            ...
            case 'text':
              return (0, t.jsx)('div', {
                ...
                children: (0, t.jsx)('div', {
                  ...
                  children: s(o.text, o.textConfig),
                }),
              });
            case 'image':
              return (0, t.jsx)('div', {
                className: 'w-full max-w-screen-2xl mx-auto px-4 md:px-0',
                children: u(o.media, 'image'),
              });
            case 'video':
              return (0, t.jsx)('div', {
                className: 'w-full max-w-screen-2xl mx-auto px-4 md:px-0',
                children: u(o.media, 'video', !1),
              });
            case 'video-autoplay':
              return (0, t.jsx)('div', {
                className: 'w-full max-w-screen-2xl mx-auto px-4 md:px-0',
                children: u(o.media, 'video', !0),
              });
            case 'image-text':
              return (0, t.jsx)('div', {
                className: 'std-grid',
                children: (0, t.jsxs)('div', {
                  ...
                  children: [
                    (0, t.jsx)('div', { children: u(o.media, 'image') }),
                    (0, t.jsx)('div', { children: s(o.text, o.textConfig) }),
                  ],
                }),
              });
            case 'text-image':
            ...
            case 'image-image':
              return (0, t.jsx)('div', {
                ...
                children: (0, t.jsxs)('div', {
                  ...
                  children: [u(o.media, 'image'), u(o.media2, 'image')],
                }),
              });
            case 'image-video':
              return (0, t.jsx)('div', {
                ...
                children: (0, t.jsxs)('div', {
                  ...
                  children: [u(o.media, 'image'), u(o.media2, 'video', !0)],
                }),
              });
            case 'video-text':
              return (0, t.jsx)('div', {
                ...
                children: (0, t.jsxs)('div', {
                  className:
                    'grid grid-cols-1 md:grid-cols-2 gap-12 items-center',
                  children: [u(o.media, 'video', !0), s(o.text, o.textConfig)],
                }),
              });
            default:
              return null;
