(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let v = ({
      ...
      if (j !== A) {
        ...
        return ('wait' === d && $.length && (e = $), P(g(e)), E(j), null);
      }
      let { forceRender: O } = (0, i.useContext)(r.LayoutGroupContext);
      return (0, t.jsx)(t.Fragment, {
        children: T.map((e) => {
          let i = x(e),
            r = (!u || !!b) && (j === T || w.includes(i));
          return (0, t.jsx)(
            f,
            {
              isPresent: r,
  ...
  (e) => {
      ...
      let s = (0, r.useReducedMotion)(),
        c = () =>
          (0, t.jsxs)(t.Fragment, {
            children: [
              (0, t.jsxs)('div', {
                className: `relative overflow-hidden rounded-md ${e.layout.height} w-full bg-white/5 transition-all duration-500 ${s ? '' : 'md:group-hover:shadow-[0_22px_54px_-12px_rgba(0,72,255,0.15)] md:group-hover:-translate-y-1 active:scale-[0.98]'}`,
                children: [
                  (0, t.jsx)('div', {
                    className:
                  ...
                  (0, t.jsx)('div', {
                    className:
                      'absolute top-4 left-4 md:left-auto md:right-4 z-20 flex gap-1.5 flex-wrap justify-start md:justify-end',
                    children: (e.tags ?? []).map((e) =>
                      (0, t.jsx)(
                        'span',
                        {
                          className:
                            'bg-[#E6EFEF]/70 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-full text-[10px] md:text-[11px] font-mono font-medium uppercase tracking-widest text-text-dark',
                          children: e,
                        },
                        e
                      )
    ...
    function u() {
      return (0, t.jsxs)('div', {
        className:
          'group relative flex flex-col md:items-center md:justify-center h-full md:min-h-[400px] bg-[#040013] p-6 md:p-12 md:overflow-hidden md:rounded-md border-none shadow-none md:transition-none',
        children: [
          (0, t.jsx)('div', {
            className:
          ...
          (0, t.jsxs)('h3', {
            className:
              'relative z-10 text-3xl md:text-5xl lg:text-6xl font-normal text-left md:text-center mb-6 md:mb-12 tracking-tight leading-[1.1] text-white transition-colors duration-300 md:group-hover:text-bluePrimary',
            children: ['Like what', (0, t.jsx)('br', {}), 'you see?'],
          }),
          (0, t.jsx)('div', {
            className:
              'relative z-10 w-full md:w-auto flex justify-end md:justify-center',
    ...
    function h({ projects: e, onProjectOpen: l }) {
      ...
      return (0, t.jsx)('section', {
        ...
        children: (0, t.jsx)(m.Container, {
          children: (0, t.jsxs)(i.motion.div, {
            ...
            className:
              'grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-x-4 md:gap-x-6 lg:gap-x-8 gap-y-6 md:gap-y-12',
            children: [
              a.map((e) =>
                e?.layout
                  ? (0, t.jsx)(
                      ...
                      {
                        variants: o,
                        className: `w-full col-span-4 ${e.layout.cols}`,
        ...
        children: (0, t.jsxs)('section', {
          ...
          children: [
            ...
            (0, t.jsx)('div', {
              ...
              children: (0, t.jsx)('div', {
                className:
                  'flex items-center md:items-end justify-center w-full h-screen md:sticky md:top-0 lg:pb-20',
                children: (0, t.jsx)('div', {
                  className: 'translate-y-[24vh] md:translate-y-0 md:pb-12',
  ...
  (e) => {
    ...
    function g({
      ...
      let v = Array.isArray(e.title) ? e.title : [e.title],
        b = (0, i.useRef)(null),
        { scrollYProgress: y } = (0, c.useScroll)({
          target: b,
  ...
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/f9a03e79eef0154f.js'].map((t) => e.l(t))
      ).then(() => t(99202))
    );
  },
]);
