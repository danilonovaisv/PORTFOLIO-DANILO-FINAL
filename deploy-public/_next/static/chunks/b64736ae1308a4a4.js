(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    function o({ assets: e, children: o }) {
      let l = (0, i.useMemo)(() => {
          ...
          return (
            e.forEach((e) => {
              if (e.href) {
                let i = (0, r.validateExternalUrl)(e.href);
                t[e.key] = { ...e, href: i };
              } else t[e.key] = e;
            }),
            t
      ...
      return (0, t.jsx)(s.Provider, { value: n, children: o });
    }
    function l(e, t) {
  ...
  (e) => {
    ...
    var t = e.i(84833);
    function i(e) {
      let [i, r] = (0, t.useState)(!1);
      return (
        (0, t.useEffect)(() => {
          let t = window.matchMedia(e);
          t.matches !== i && r(t.matches);
          let s = (e) => r(e.matches);
          return (
      ...
      n = class {
        ...
        onWheel = (e) => {
          let { deltaX: t, deltaY: i, deltaMode: r } = e,
            s = 1 === r ? o : 2 === r ? this.window.width : 1,
            l = 1 === r ? o : 2 === r ? this.window.height : 1;
          ((t *= s),
            (i *= l),
      ...
      h = class {
        ...
        constructor({
          ...
          ((window.lenisVersion = '1.3.17'),
            ...
            (this.dimensions = new r(e, t, { autoResize: b })),
        ...
        checkNestedScroll(e, { deltaX: t, deltaY: i }) {
          ...
          if (
            ...
            return !1;
          if ('x' === u)
            ((d = e.scrollLeft), (p = n - h), (f = t), (m = r), (g = o));
          else {
            if ('y' !== u) return !1;
            ((d = e.scrollTop), (p = a - c), (f = i), (m = s), (g = l));
          }
  ...
  (e) => {
    ...
    async function n() {
      ...
      return (function (e, t = {}) {
          ...
          let e = (function (e) {
              let t = (e.bucket || 'site-assets')
                ...
                i = e.key
                  ...
                  .replace(/,+$/g, '')
                  .trim(),
                r = (0, l.normalizeStoragePath)(e.file_path, t),
                s = r
                ...
                a = n(e.page) || n(s) || n(i) || 'global',
                h =
                  (0, l.buildSupabaseStorageUrl)(o, s) ||
            ...
            c = e.key?.trim();
          if (!c || (r && (n(c) || n(e.file_path))) || (i && !e.is_active))
            continue;
        ...
        let c = new Map();
        for (let e of s.values()) c.set(e.id, e);
    ...
    var a = e.i(63844),
      h = e.i(69527);
    let c = (0, r.createContext)({ lenis: null }),
      u = (e) => {
        let t,
          i = new Set(),
          r = (e, r) => {
    ...
    function f({ children: e }) {
      ...
      return (
        ...
        (0, i.jsx)(c.Provider, { value: { lenis: s }, children: e })
      );
    }
    var m = e.i(32648),
      g = e.i(54768),
      ...
      return (0, i.jsx)('header', {
        ...
        children: (0, i.jsx)('div', {
          ...
          children: (0, i.jsx)('div', {
            ...
            children: (0, i.jsx)('div', {
              className: `${y.default.headerContainer} ${l ? y.default.headerLight : y.default.headerDark} h-16 w-[calc(100%+5rem)] -ml-10 rounded-4xl backdrop-blur-md border border-white/10 bg-black/20 transition-all duration-300`,
    ...
    let S = (0, r.forwardRef)(
      (
        ...
        (0, i.jsxs)('button', {
          ...
          'aria-expanded': e,
          className: `relative inline-flex items-center justify-center gap-2 bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible z-110 min-h-[48px] min-w-[48px] px-3 transition-colors duration-300 ${e ? 'text-primary' : 'text-white hover:text-primary'}`,
          children: [
            (0, i.jsx)('span', {
              className:
                ...
                return (0, i.jsx)(
                  'li',
                  {
                    ...
                    children: (0, i.jsx)('button', {
                      onClick: () => o(e.href),
                      className: `sm-panel-item text-4xl font-light tracking-wide transition-colors text-left leading-none uppercase will-change-transform origin-bottom ${(a ? 'text-primary font-semibold' : '') || (n === t ? 'text-primary font-medium' : 'text-white/80 hover:text-white')}`,
                      children: e.label,
                    }),
                  },
                  e.href
    ...
    let M = (0, r.forwardRef)((e, t) =>
      (0, i.jsx)('div', {
        ref: t,
        className:
          'fixed top-0 right-0 bottom-0 w-full pointer-events-none z-40',
        'aria-hidden': 'true',
    ...
    function T({ logoUrl: e, onLogoClick: t, children: r, isLight: s = !1 }) {
      let o = {
        ...
        children: (0, i.jsx)('div', {
          ...
          children: (0, i.jsxs)('div', {
            ...
            children: [
              ...
              (0, i.jsx)(k.motion.div, { variants: o, children: r }),
            ],
          }),
        }),
      });
        ...
        (0, r.useLayoutEffect)(() => {
          let e = C.gsap.context(() => {
            ...
            (t && (p = Array.from(t.querySelectorAll('.sm-prelayer'))),
              ...
              C.gsap.set(r, { transformOrigin: '50% 50%', rotate: 90 }),
        ...
        let k = (0, r.useCallback)((e) => {
          ...
          _ = (0, r.useCallback)(() => {
            ...
            let i = e.querySelectorAll('.sm-panel-item'),
              r = n.current,
              o = r ? Array.from(r.querySelectorAll('.sm-social-link')) : [],
              a = r?.querySelector('.sm-social-title');
            (i.length &&
          ...
          j = (0, r.useCallback)(() => {
            e !== S.current &&
              (e
                ? ((S.current = !0), x(!0), N(), k(!0), E(!0))
                : ((S.current = !1), x(!1), L(), k(!1), E(!1)));
          }, [e, N, L, k, E]);
        return (
          (0, r.useLayoutEffect)(() => {
            (e !== S.current && (e ? E(!0) : E(!1)), (S.current = e), x(e));
          }, [e, E]),
          {
            refs: {
              panelRef: s,
    ...
    function z({ navItems: e, gradient: t, accentColor: o }) {
      ...
      let b = (function (e, t = '-45% 0px -45% 0px') {
        ...
        w = (0, a.usePathname)(),
        y = (0, r.useMemo)(() => ('/' === w ? b : (w ?? void 0)), [w, b]),
    ...
    function O({ children: e }) {
      let t = (0, a.usePathname)(),
        s = (0, r.useMemo)(() => t?.startsWith('/admin') ?? !1, [t]);
      return (!(function (e = !0) {
