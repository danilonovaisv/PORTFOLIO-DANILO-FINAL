(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
      ...
      getSnapshotBeforeUpdate(e) {
        ...
        if (t && e.isPresent && !this.props.isPresent) {
          let e = t.offsetParent,
            i = ((0, r.isHTMLElement)(e) && e.offsetWidth) || 0,
            a = ((0, r.isHTMLElement)(e) && e.offsetHeight) || 0,
    ...
    function m({ children: e, isPresent: a, anchorX: s, anchorY: l, root: n }) {
      let r = (0, o.useId)(),
        m = (0, o.useRef)(null),
        p = (0, o.useRef)({
          width: 0,
        ...
        { nonce: h } = (0, o.useContext)(d.MotionConfigContext),
        x = (function (...e) {
      ...
      return (
        (0, o.useInsertionEffect)(() => {
          ...
          let u = 'left' === s ? `left: ${o}` : `right: ${d}`,
            x = 'bottom' === l ? `bottom: ${c}` : `top: ${i}`;
    ...
    let p = ({
      ...
      return (
        ...
        (0, t.jsx)(n.PresenceContext.Provider, { value: y, children: e })
      );
    };
    function h() {
      return new Map();
    ...
    let b = ({
      ...
      if (j !== E) {
        ...
        for (let t = 0; t < M.length; t++) {
          let i = M[t],
            a = f(i);
          w.includes(a) || (e.splice(t, 0, i), T.push(i));
        }
        return ('wait' === c && T.length && (e = T), S(g(e)), P(j), null);
      }
  ...
  (e) => {
    ...
    function o() {
      let e = (0, s.useMediaQuery)('(max-width: 768px)'),
        i = (0, l.useSiteAssetUrl)(
          n.SITE_ASSET_KEYS.heroVideos.portfolioDesktop,
          a.PORTFOLIO_CONTENT.hero.video.desktop
        ),
        o = (0, l.useSiteAssetUrl)(
          n.SITE_ASSET_KEYS.heroVideos.portfolioMobile,
          a.PORTFOLIO_CONTENT.hero.video.mobile
        ),
        d = e ? o : i;
    ...
    let m = [
      ...
      p = [0.22, 1, 0.36, 1],
      h = ({ activeCategory: e, onChange: i, className: a = '' }) =>
        (0, t.jsx)('div', {
          ...
          children: m.map((a, s) => {
            ...
            return (0, t.jsxs)(
              c.motion.button,
              {
                ...
                transition: { duration: 0.5, ease: p, delay: 0.05 * s },
                onClick: () => i(a.id),
                'aria-pressed': l,
                className: `
              ...
              ${l ? 'text-white' : 'text-white/60 hover:text-white/90'}
            `,
                children: [
                  l &&
    ...
    let v = function (e = {}) {
      let {
        ...
        [c, u] = (0, i.useState)(0);
      (0, i.useEffect)(() => {
        let e = () => r(window.innerWidth < 1024);
        return (
          e(),
      ...
      let m = a && !n,
        { scrollYProgress: p } = (0, y.useScroll)({
          target: s,
      ...
      (0, i.useEffect)(() => {
        ...
        let e = () => {
            (l.current && d(l.current.offsetHeight), u(window.innerHeight));
          },
          t = new ResizeObserver(e);
        return (t.observe(l.current), e(), () => t.disconnect());
      }, [m]);
      let x = (0, b.useTransform)(h, [0, 1], [0, -(o - c)]);
      return {
        galleryRef: s,
        trackRef: l,
        style: { y: m ? x : 0 },
    ...
    var j = e.i(78923),
      w = e.i(57023),
      N = e.i(63844);
    let { duration: k, spring: A, stagger: C } = j.MOTION_TOKENS,
      E = ({ project: e, index: a, onOpen: s, className: l = '' }) => {
        let n = (0, u.useReducedMotion)(),
          r = (0, N.useRouter)(),
          o = (0, i.useRef)(null),
          [d, m] = (0, i.useState)(!1),
          { ref: p, style: h } = (function (e = {}) {
            let { speed: t = 0.2, direction: a = 'up', enabled: s = !0 } = e,
              l = (0, i.useRef)(null),
              { scrollYProgress: n } = (0, y.useScroll)({
                target: l,
              ...
              o = (0, b.useTransform)(
                r,
                [0, 1],
                'up' === a ? [20 * t, -20 * t] : [-20 * t, 20 * t],
                { ease: (e) => e }
              );
            return { ref: l, style: { y: s ? o : 0 } };
          })({ speed: 0.15, direction: 'up', enabled: !n }),
          v = () => {
            e.landingPageSlug
              ? r.push(`/projects/${e.landingPageSlug}?from=portfolio`)
              : s && s(e);
          };
        return (0, t.jsxs)(c.motion.article, {
          ref: (e) => {
            ((o.current = e), (p.current = e));
          },
          initial: { opacity: 0, y: 24, filter: 'blur(4px)' },
          whileInView: { opacity: 1, y: 0, filter: 'blur(0px)' },
          viewport: { once: !0, margin: '-50px' },
          transition: (0, j.ghostTransition)(a * C.tight, k.normal),
          className: `group relative overflow-hidden rounded-2xl md:rounded-3xl cursor-pointer bg-white/5 will-change-transform ${e.layout.cols} ${e.layout.height} ${l}`,
          onMouseEnter: () => m(!0),
          onMouseLeave: () => m(!1),
          onClick: v,
          role: 'button',
          ...
          children: [
            (0, t.jsx)('div', {
              ...
              children: (0, t.jsx)(c.motion.div, {
                ...
                style: n ? {} : h,
                animate: { y: d ? -8 : 0 },
                transition: (0, j.ghostTransition)(0, k.normal),
                children: (0, w.isVideo)(e.image)
                  ? (0, t.jsx)('video', {
                      src: e.image,
                      autoPlay: !0,
                      muted: !0,
            ...
            e.videoPreview &&
              (0, t.jsx)(c.motion.div, {
                ...
                children: (0, w.isVideo)(e.videoPreview)
                  ? (0, t.jsx)('video', {
                      src: e.videoPreview,
                      autoPlay: !0,
                      muted: !0,
            ...
            (0, t.jsx)('div', {
              ...
              'aria-hidden': 'true',
              children: (0, t.jsx)(c.motion.span, {
                className:
                  'inline-flex items-center rounded-full bg-white/10 backdrop-blur-md border border-white/10 px-3 py-1.5 text-[10px] md:text-xs font-medium uppercase tracking-wide text-white',
                animate: { opacity: 1, y: 0 },
                transition: { duration: 0.3 },
              ...
              children: (0, t.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, t.jsx)(c.motion.div, {
                    ...
                    style: { backgroundColor: d ? '#8705f2' : '#0048ff' },
                    initial: { opacity: 0, y: 10 },
                    animate: { opacity: 1, y: 0 },
                    transition: { type: 'spring', ...A.snappy },
                    whileHover: n ? void 0 : { x: 4 },
    ...
    let M = [0.22, 1, 0.36, 1],
      S = ({
        ...
        let [o, m] = (0, i.useState)('all'),
          ...
          [y, j] = (0, i.useState)('auto'),
          w = (0, i.useMemo)(() => {
            let t = 'all' === o ? e : e.filter((e) => e.category === o);
            return (l && (t = t.slice(0, l)), t);
          }, [o, l, e]);
        return (
          (0, i.useEffect)(() => {
            if (!f.current || p) return void j('auto');
            let e = () => {
                if (f.current) {
          ...
          (0, t.jsx)('section', {
            ...
            className: `relative z-10 bg-background transition-[height] duration-300 ease-out h-(--gallery-height) ${n}`,
                ...
                (0, t.jsxs)(P.Container, {
                  children: [
                    ...
                    (0, t.jsx)(c.motion.div, {
                      layout: !p,
                      className:
                        'grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-x-8 md:gap-y-24',
                      role: 'tabpanel',
                      id: `projects-${o}`,
        ...
        (0, t.jsxs)('div', {
          ...
          children: [
            (0, t.jsxs)(c.motion.div, {
              ...
              className:
                'relative w-full aspect-video md:aspect-21/9 rounded-2xl overflow-hidden bg-white/5',
              children: [
                (0, w.isVideo)(e.image)
                  ? (0, t.jsx)('video', {
                      src: e.image,
                ...
                (0, t.jsx)('div', {
                  ...
                  children: (0, t.jsx)('span', {
                    className:
                      'inline-flex items-center rounded-full bg-white/90 backdrop-blur-sm px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-gray-900',
                    children: e.displayCategory,
                  }),
                }),
              ],
                      ...
                      (0, t.jsx)('div', {
                        ...
                        children: e.tags.map((e) =>
                          (0, t.jsx)(
                            ...
                            {
                              className:
                                'px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-white/70',
                              children: e,
                            },
                            e
                          )
                    ...
                    e.detail?.externalUrl &&
                      (0, t.jsxs)('a', {
                        ...
                        children: [
                          ...
                          (0, t.jsx)(f.ArrowUpRight, { className: 'w-4 h-4' }),
                        ],
                      }),
                  ],
                }),
    ...
    let V = {
            ...
            (0, t.jsxs)(c.motion.div, {
              ...
              children: [
                ...
                (0, t.jsx)('div', {
                  ...
                  children: (0, t.jsx)('span', {
                    className:
                      'inline-flex items-center rounded-full bg-black/60 backdrop-blur-sm px-3 py-1 text-xs font-medium text-white',
                    children: e.displayCategory,
                  }),
                }),
              ],
                      ...
                      (0, t.jsxs)(t.Fragment, {
                        children: [
                          ...
                          (0, t.jsxs)('span', {
                            className: 'flex items-center gap-2',
                            children: [
                              (0, t.jsx)(U.Tag, { className: 'w-4 h-4' }),
                  ...
                  (0, t.jsx)(c.motion.div, {
                    ...
                    children: e.tags.map((e) =>
                      (0, t.jsx)(
                        ...
                        {
                          className:
                            'px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-white/60',
                          children: e,
                        },
                        e
                      )
      ...
      { offset: F } = j.MOTION_TOKENS;
    function D({ project: e, isOpen: a, onClose: s }) {
      let l,
        [n, r] = (0, i.useState)(!1),
        o = (0, i.useRef)(null),
        m = (0, i.useRef)(null),
      ...
      if (!n) return null;
      let x = (0, t.jsx)(d.AnimatePresence, {
        mode: 'wait',
        children:
          a &&
          e &&
            ...
            children: [
              ...
              (0, t.jsx)(
                c.motion.div,
                {
                  ...
                  initial: p ? { opacity: 0 } : { opacity: 0, y: F.large },
                  animate: { opacity: 1, y: 0 },
                  exit: p ? { opacity: 0 } : { opacity: 0, y: F.standard },
                  transition: (0, j.ghostTransition)(
                    0.12 * !p,
                    p ? 0.15 : 0.26
                  ),
      ...
      return (0, T.createPortal)(x, document.body);
    }
    var K = e.i(22621);
    function B({ projects: e }) {
      ...
      return (0, t.jsxs)('div', {
        ...
        children: [
          (0, t.jsx)(o, {}),
          (0, t.jsx)(S, { projects: e, onProjectOpen: r, isPaused: l }),
          (0, t.jsx)(D, { project: a, isOpen: l, onClose: d }),
          (0, t.jsx)(K.SiteClosure, {}),
        ],
      });
    }
    e.s(['default', () => B], 70432);
