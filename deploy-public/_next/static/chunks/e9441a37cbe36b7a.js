(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function m({ children: e, isPresent: a, anchorX: l, anchorY: s, root: n }) {
      let r = (0, o.useId)(),
        m = (0, o.useRef)(null),
        p = (0, o.useRef)({
          width: 0,
        ...
        { nonce: x } = (0, o.useContext)(d.MotionConfigContext),
        h = (function (...e) {
      ...
      return (
        (0, o.useInsertionEffect)(() => {
          ...
          let u = 'left' === l ? `left: ${o}` : `right: ${d}`,
            h = 'bottom' === s ? `bottom: ${c}` : `top: ${i}`;
  ...
  (e) => {
    ...
    let v = function (e = {}) {
      ...
      (0, i.useEffect)(() => {
        ...
        let e = () => {
            (s.current && d(s.current.offsetHeight), u(window.innerHeight));
          },
          t = new ResizeObserver(e);
        return (t.observe(s.current), e(), () => t.disconnect());
      }, [m]);
      let h = (0, b.useTransform)(x, [0, 1], [0, -(o - c)]);
      return {
        galleryRef: l,
        trackRef: s,
        style: { y: m ? h : 0 },
    ...
    var j = e.i(78923),
      w = e.i(57023),
      N = e.i(63844);
    let { duration: k, spring: E, stagger: A } = j.MOTION_TOKENS,
      C = ({ project: e, index: a, onOpen: l, className: s = '' }) => {
        let n = (0, u.useReducedMotion)(),
          r = (0, N.useRouter)(),
          o = (0, i.useRef)(null),
          [d, m] = (0, i.useState)(!1),
          { ref: p, style: x } = (function (e = {}) {
            let { speed: t = 0.2, direction: a = 'up', enabled: l = !0 } = e,
              s = (0, i.useRef)(null),
        ...
        return (0, t.jsxs)(c.motion.article, {
          ...
          transition: (0, j.ghostTransition)(a * A.tight, k.normal),
          className: `card-shell group relative overflow-hidden rounded-2xl md:rounded-3xl cursor-pointer bg-white/5 will-change-transform ${e.layout.cols} ${s}`,
          onMouseEnter: () => m(!0),
          onMouseLeave: () => m(!1),
          onClick: v,
          role: 'button',
          ...
          children: [
            (0, t.jsx)('div', {
              className: 'card-media overflow-hidden',
              ...
              children: (0, t.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, t.jsx)(c.motion.div, {
                    ...
                    initial: { opacity: 0, y: 10 },
                    animate: { opacity: 1, y: 0 },
                    transition: { type: 'spring', ...E.snappy },
    ...
    let U = {
      ...
      { offset: H } = j.MOTION_TOKENS;
    function D({ project: e, isOpen: a, onClose: l }) {
      let s,
        [n, r] = (0, i.useState)(!1),
        o = (0, i.useRef)(null),
        m = (0, i.useRef)(null),
      ...
      if (!n) return null;
      let h = (0, t.jsx)(d.AnimatePresence, {
        mode: 'wait',
        children:
          a &&
          e &&
      ...
      return (0, T.createPortal)(h, document.body);
    }
    var K = e.i(22621);
    function B({ projects: e }) {
      ...
      return (0, t.jsxs)('div', {
        ...
        children: [
          (0, t.jsx)(o, {}),
          (0, t.jsx)(S, { projects: e, onProjectOpen: r, isPaused: s }),
          (0, t.jsx)(D, { project: a, isOpen: s, onClose: d }),
