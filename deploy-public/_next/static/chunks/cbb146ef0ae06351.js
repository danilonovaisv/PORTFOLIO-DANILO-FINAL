(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let b = ({
      ...
      if (j !== C) {
        ...
        return ('wait' === c && S.length && (e = S), T(g(e)), P(j), null);
      }
  ...
  (e) => {
    ...
    let { duration: w, spring: N, stagger: k } = y.MOTION_TOKENS,
      E = ({ project: e, index: a, onOpen: l, className: s = '' }) => {
        let r = (0, u.useReducedMotion)(),
          ...
          [d, m] = (0, i.useState)(!1),
          p = (0, i.useRef)(null),
          { scrollYProgress: h } = (0, f.useScroll)({
            target: p,
            offset: ['start end', 'end start'],
          }),
          E = (0, g.useTransform)(h, [0, 1], ['-12%', '12%']),
          A = () => {
            e.landingPageSlug
    ...
    let C = function (e = {}) {
      ...
      let x = (0, g.useTransform)(h, [0, 1], [0, -(o - c)]);
      return {
        galleryRef: l,
        trackRef: s,
        style: { y: m ? x : 0 },
                ...
                (0, t.jsxs)(P.Container, {
                  children: [
                    ...
                    (0, t.jsx)(c.motion.div, {
                      layout: !p,
                      className:
                        'grid grid-cols-1 md:grid-cols-12 gap-0 items-stretch',
                      role: 'tabpanel',
                      id: `projects-${o}`,
    ...
    function D({ projects: e }) {
      ...
      return (0, t.jsxs)('div', {
        ...
        children: [
          ...
          (0, t.jsx)(K, { project: a, isOpen: s, onClose: d }),
