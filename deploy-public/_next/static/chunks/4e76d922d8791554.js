(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, i) => {
    ...
    ((y.dynamic = function (e) {
      ...
      (i.StyleRegistry = function (e) {
        ...
        return a.default.createElement(f.Provider, { value: n }, i);
      }),
  ...
  (e) => {
    ...
    function m() {
      ...
      let x = (0, n.useSpring)(h, c.motionSprings.ghost),
        g = (0, l.useTransform)(x, [0, 1], e ? [0, 0] : [48, -48]),
            ...
            (r.default.set(t, {
              ...
              y.forEach((i, n) => {
                let l = e[n],
                  ...
                  c = t[n + 1];
                if (n < y.length - 1) {
                  let e = r.default.timeline({ paused: !0 });
                  (e
                    .to(
                      'body',
                      {
                        backgroundColor: s[n + 1],
                        duration: 1.5,
                        ease: 'none',
                      },
                      0
  ...
  (e) => {
    ...
    var t = e.i(96148),
      ...
      a = e.i(43683),
      n = e.i(45439);
    let l = ({ index: e, text: i, prefersReducedMotion: r }) => {
        let [a, ...l] = i.split(' '),
          o = l.join(' ');
        return (0, t.jsx)(s.motion.article, {
          ...
          children: (0, t.jsxs)('div', {
            ...
            children: [
              (0, t.jsx)('span', {
                className:
                  'flex h-10 w-10 items-center justify-center rounded-full bg-[#204fff] text-white',
                children: (0, t.jsx)(n.ArrowUpRight, { size: 18 }),
              }),
              (0, t.jsxs)('p', {
                className:
        ...
        return (0, t.jsxs)(s.motion.article, {
          ...
          children: [
            (0, t.jsx)('span', {
              ...
              children: (0, t.jsx)(n.ArrowUpRight, { size: 16 }),
            }),
            (0, t.jsxs)('p', {
    ...
    function c() {
      let e = !!(0, r.useReducedMotion)(),
        n = a.ABOUT_CONTENT.whatIDo.cards,
  ...
  (e) => {
    ...
    function m() {
      let e = (0, i.useRef)(null),
        ...
        x = m ? p : f,
        g = (0, n.useTransform)(x, [0, 1], m ? [0, 0] : [16, -16]),
        v = (0, n.useTransform)(x, [0, 1], m ? ['0%', '0%'] : ['-10%', '10%']);
      return (0, t.jsxs)('section', {
        ref: e,
        className:
  ...
  (e) => {
    ...
    var t = e.i(96148),
      ...
      a = e.i(35315),
      n = e.i(37076);
    let l = ({ text: e, bgColor: l, isFirst: o = !1 }) => {
        let c = (0, i.useRef)(null),
          ...
          m = o ? [0.9, 1] : [0.8, 0.95],
          h = (0, n.cubicBezier)(0.22, 1, 0.36, 1),
          p = (0, a.useTransform)(d, [u[0], u[1], m[0], m[1]], [0, 1, 1, 0]),
          f = (0, a.useTransform)(d, [0.7, 0.95], ['0vh', '-100vh']),
          x = e.split('\n');
        return (0, t.jsx)('section', {
          ref: c,
          className: `relative w-full h-screen flex justify-start overflow-hidden transition-colors duration-500 ease-linear ${o ? 'items-center pt-0' : 'items-start pt-[20vh] md:pt-[20vh] lg:pt-[15vh]'} ${l}`,
          children: (0, t.jsx)('div', {
      ...
      c = ({ opacity: e, progress: i }) => {
        let r = (0, n.cubicBezier)(0.22, 1, 0.36, 1),
          l = (0, a.useTransform)(i, [0.05, 0.15], [30, 0], { ease: r }),
      ...
      m = () => {
        let e = i.default.useRef(null),
          ...
          m = (0, n.cubicBezier)(0.22, 1, 0.36, 1),
        ...
        return (0, t.jsxs)('section', {
          ...
          children: [
            ...
            d.map((e, i) =>
              (0, t.jsx)(l, { text: e, bgColor: u[i], isFirst: 0 === i }, i)
            ),
    ...
    function l() {
      ...
      return (0, t.jsx)('section', {
        ...
        children: (0, t.jsxs)(i.motion.div, {
          variants: n.motionTokens.fadeGhost,
          initial: e ? 'visible' : 'hidden',
          whileInView: 'visible',
          ...
          children: [
            ...
            (0, t.jsxs)('div', {
              ...
              children: [
                (0, t.jsxs)('p', {
                  className:
                    'type-h2 text-text opacity-90 max-w-[800px] leading-snug mx-auto text-center',
                  children: [
