(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
                  ...
                  (0, t.jsx)('div', {
                    ...
                    children: (e.tags ?? []).map((e) =>
                      (0, t.jsx)(
                        ...
                        {
                          className:
                            'bg-[#E6EFEF]/60 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-full text-[10px] md:text-[11px] font-mono font-medium uppercase tracking-widest text-[#040013]',
                          children: e,
                        },
                        e
                      )
    ...
    function u() {
      return (0, t.jsxs)('div', {
        className:
          'card-shell group relative flex flex-col md:items-center md:justify-center h-full bg-[#040013] p-6 md:p-12 md:overflow-hidden md:rounded-md border-none shadow-none md:transition-none',
        children: [
          (0, t.jsx)('div', {
            className:
