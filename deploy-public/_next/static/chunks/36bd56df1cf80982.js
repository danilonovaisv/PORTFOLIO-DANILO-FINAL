(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let i = { fadeGhost: t.ghostFade, riseSoft: t.riseSoft },
      a = { ghost: t.MOTION_TOKENS.spring.ghost };
    e.s(['motionSprings', 0, a, 'motionTokens', 0, i]);
  },
  37560,
  (e) => {
    'use strict';
    ...
    function x() {
      let e = (0, s.useReducedMotion)(),
        x = (0, i.useRef)(null),
        { scrollYProgress: u } = (0, l.useScroll)({
          target: x,
      ...
      let h = (0, r.useSpring)(u, c.motionSprings.ghost),
        g = (0, o.useTransform)(h, [0, 1], e ? [0, 0] : [48, -48]),
        b = (0, d.useSiteAssetUrl)(
          m.SITE_ASSET_KEYS.heroVideos.aboutDesktop,
          n.ABOUT_CONTENT.hero.videos.desktop ||
            '/public/videos/about.hero.desktop_video.mp4'
        ),
        v = (0, d.useSiteAssetUrl)(
          m.SITE_ASSET_KEYS.heroVideos.aboutMobile,
          n.ABOUT_CONTENT.hero.videos.mobile ||
      ...
      return (0, t.jsxs)('section', {
        ...
        children: [
          (0, t.jsx)(a.motion.video, {
            ref: p,
            src: b || '/public/videos/about.hero.desktop_video.mp4',
            autoPlay: !0,
            muted: !0,
            loop: !0,
            playsInline: !0,
                    ...
                    children: (0, t.jsxs)('div', {
                      ...
                      children: [
                        (0, t.jsxs)(a.motion.div, {
                          ...
                          children: [
                            (0, t.jsxs)('h1', {
                              ...
                              children: [
                                n.ABOUT_CONTENT.hero.title.text,
                                (0, t.jsx)('span', {
                                  className: 'text-bluePrimary',
                                  children:
                                    n.ABOUT_CONTENT.hero.title.highlight,
                                }),
                              ],
                            }),
                            (0, t.jsx)('div', {
                              className: 'flex flex-col items-end',
                              children: n.ABOUT_CONTENT.hero.manifesto.map(
                                (e, i) =>
                                  (0, t.jsxs)(
                                    'p',
                                    {
                        ...
                        (0, t.jsx)(a.motion.div, {
                          ...
                          children: n.ABOUT_CONTENT.hero.description.join(' '),
                        }),
                      ],
                    }),
                  }),
                  ...
                  children: [
                    (0, t.jsx)(a.motion.div, {
                      ...
                      children: (0, t.jsxs)('h1', {
                        className:
                          'type-h1 text-text-light leading-[1.1] flex flex-col gap-1',
                        children: [
                          (0, t.jsxs)('span', {
                            children: [
                              'Sou ',
                    ...
                    (0, t.jsx)(a.motion.div, {
                      ...
                      className:
                        'text-[18px] md:type-h3 text-white leading-[1.6] tracking-tight max-w-[98%] mx-auto',
                      children: n.ABOUT_CONTENT.hero.description.map((e, i) =>
                        (0, t.jsx)(
                          'span',
  ...
  (e) => {
    ...
    var t = e.i(96148),
      ...
      n = e.i(72928),
      c = e.i(62596);
    s.default.registerPlugin(l.ScrollTrigger);
    let d = [
      {
        id: '1',
    ...
    e.s([
      ...
      () => {
        let e = (0, i.useRef)(null),
          ...
          p =
            (0, o.useSiteAssetUrl)(
              n.SITE_ASSET_KEYS.about.originImages[0],
              (0, c.buildSupabaseStorageUrl)('site-assets', d[0].fallback)
            ) ?? (0, c.buildSupabaseStorageUrl)('site-assets', d[0].fallback),
          f =
            (0, o.useSiteAssetUrl)(
              n.SITE_ASSET_KEYS.about.originImages[1],
              (0, c.buildSupabaseStorageUrl)('site-assets', d[1].fallback)
            ) ?? (0, c.buildSupabaseStorageUrl)('site-assets', d[1].fallback),
          h =
            (0, o.useSiteAssetUrl)(
              n.SITE_ASSET_KEYS.about.originImages[2],
              (0, c.buildSupabaseStorageUrl)('site-assets', d[2].fallback)
            ) ?? (0, c.buildSupabaseStorageUrl)('site-assets', d[2].fallback),
          g =
            (0, o.useSiteAssetUrl)(
              n.SITE_ASSET_KEYS.about.originImages[3],
              (0, c.buildSupabaseStorageUrl)('site-assets', d[3].fallback)
            ) ?? (0, c.buildSupabaseStorageUrl)('site-assets', d[3].fallback),
          b = [
            { ...d[0], img: p },
            { ...d[1], img: f },
        ...
        return (
          (0, i.useEffect)(() => {
            ...
            ((u.current = e),
              ...
              e.on('scroll', l.ScrollTrigger.update));
            let t = s.default.matchMedia();
            return (
              t.add('(min-width: 1024px)', () => {
                if (!m.current || !x.current) return;
                let e = s.default.utils.toArray('.img-wrapper'),
                  t = s.default.utils.toArray('.img-wrapper img'),
                  i = s.default.utils.toArray('.arch__info'),
                  a = ['#040013', '#060018', '#08001e', '#0a001a'],
                  l = s.default.timeline({
                    scrollTrigger: {
                      trigger: m.current,
                      start: 'top top',
                      end: 'bottom bottom',
                ...
                (s.default.set(t, {
                  ...
                  b.forEach((i, r) => {
                    let o = e[r],
                      n = t[r],
                      c = t[r + 1],
                      d = s.default.timeline();
                    r < b.length - 1 &&
                      (d
                        .to(
                          'body',
                          {
                            backgroundColor: a[r + 1],
                            duration: 1.5,
                            ease: 'none',
                          },
                          0
              ...
              t.add('(max-width: 1023px)', () => {
                let e = s.default.utils.toArray('.mobile-img-container'),
                  t = s.default.utils.toArray('.mobile-text-container'),
              ...
              setTimeout(() => l.ScrollTrigger.refresh(), 500),
              () => {
                (t.revert(),
                  e.destroy(),
                  l.ScrollTrigger.getAll().forEach((e) => e.kill()));
              }
            );
          }, []),
          (0, t.jsx)('section', {
            ...
            children: (0, t.jsxs)('div', {
              className:
                'max-w-[1680px] mx-auto px-6 md:px-12 lg:px-16 xl:px-24 py-24',
              children: [
                (0, t.jsx)('div', {
                ...
                (0, t.jsxs)('div', {
                  className:
                    'arch relative grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-8 md:gap-12 max-w-[1440px] mx-auto',
                  ref: m,
                  children: [
                    (0, t.jsx)('div', {
                      className:
                      ...
                      children: b.map((e) =>
                        (0, t.jsx)(
                          'div',
                          {
                            ...
                            children: (0, t.jsxs)('div', {
                              className:
                                'content w-full lg:max-w-[520px] flex flex-col gap-8 lg:transform lg:-translate-y-[15%]',
                              children: [
                                (0, t.jsxs)('div', {
                                ...
                                (0, t.jsx)('div', {
                                  className:
                                    'mobile-img-container lg:hidden relative mt-8 w-full aspect-square min-h-[240px] rounded-[24px] overflow-hidden bg-[#060018] shadow-2xl',
                      ...
                      children: (0, t.jsx)('div', {
                        ...
                        children: b.map((e) =>
                          (0, t.jsx)(
                            ...
                            {
                              className:
                                'img-wrapper absolute inset-0 rounded-[24px] overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,0,0,1)] bg-[#040013]',
                              children: (0, t.jsx)(a.default, {
                                src: e.img,
                                alt: e.alt,
                                fill: !0,
  ...
  (e) => {
    ...
    let c = ({
        ...
        let o = 0.02 * e,
          ...
          d = (0, n.useTransform)(s, [0.05 + o, 0.2 + o], [0, 1]),
          m = (0, n.useTransform)(s, [0.05 + o, 0.2 + o], [8, 0]),
          x = (0, r.useSpring)(c, {
            stiffness: 40,
            damping: 30,
            restDelta: 0.001,
        ...
        return l
          ? (0, t.jsxs)('article', {
              ...
              'aria-label': i,
              className:
                'group relative flex flex-row items-center text-white outline-none bg-[#0048ff] min-h-[140px] w-[260px] shrink-0 rounded-[16px] px-5 py-5 gap-4 focus-visible:ring-2 focus-visible:ring-[#4fe6ff]',
              children: [
                (0, t.jsx)('div', {
                  className:
                    'text-[2.5rem] font-black leading-none text-[#8705f2]',
                  children: f,
                }),
                (0, t.jsx)('p', {
          ...
          : (0, t.jsxs)(a.motion.article, {
              tabIndex: 0,
              'aria-label': i,
              className:
                'group relative flex flex-row items-center text-white outline-none will-change-transform bg-[#0048ff] min-h-[140px] w-[260px] shrink-0 rounded-[16px] px-5 py-5 gap-4 hover:brightness-110 focus-visible:ring-2 focus-visible:ring-[#4fe6ff]',
              style: {
                x: x,
                opacity: u,
                filter: (0, n.useTransform)(p, (e) => `blur(${e}px)`),
              },
              children: [
                (0, t.jsx)('div', {
                  className:
                    'text-[2.5rem] font-black leading-none text-[#8705f2] transition-colors duration-200 group-hover:text-white',
                  children: f,
                }),
                (0, t.jsx)('p', {
                  className: 'text-[0.95rem] font-bold leading-tight',
      ...
      d = ({ index: e, text: i, prefersReducedMotion: s }) => {
        let l = `${e + 1}`.padStart(2, '0');
        return (0, t.jsxs)(a.motion.article, {
          tabIndex: 0,
          'aria-label': i,
          ...
          className:
            'group relative flex flex-col items-center justify-center text-center text-white outline-none bg-[#0048ff] w-full h-auto min-h-[100px] py-6 rounded-[12px] px-6 gap-2 hover:brightness-110 focus-visible:ring-2 focus-visible:ring-[#4fe6ff]',
          children: [
            (0, t.jsx)('div', {
              className:
                'text-[1.75rem] font-black leading-none text-[#8705f2] transition-colors duration-200 group-hover:text-white',
              children: l,
            }),
            (0, t.jsx)('p', {
              className:
                'text-[1rem] font-bold leading-[1.4] whitespace-normal wrap-break-word',
              children: (0, t.jsx)('span', {
                className: 'text-white',
                children: i,
              }),
    ...
    function m() {
      let e = (0, i.useRef)(null),
        n = !!(0, s.useReducedMotion)(),
        { scrollYProgress: m } = (0, l.useScroll)({
          target: e,
          offset: ['start end', 'end start'],
        }),
        x = (0, r.useSpring)(m, {
        ...
        u = o.ABOUT_CONTENT.whatIDo.cards;
      return (0, t.jsxs)('section', {
        ref: e,
        ...
        children: [
            ...
            children: (0, t.jsxs)('header', {
              ...
              children: [
                (0, t.jsxs)(a.motion.h2, {
                  initial: n ? { opacity: 1, y: 0 } : { opacity: 0, y: 24 },
                  whileInView: { opacity: 1, y: 0 },
                  viewport: { once: !0 },
                  transition: { duration: 0.6, ease: [0.22, 1, 0.36, 1] },
                  className:
                    'font-display text-[2rem] font-black leading-[1.1] tracking-tight text-white lg:text-[4rem]',
                  children: [
                    'Do ',
                    (0, t.jsx)('span', {
                ...
                (0, t.jsx)(a.motion.p, {
                  initial: n ? { opacity: 1, y: 0 } : { opacity: 0, y: 16 },
                  whileInView: { opacity: 1, y: 0 },
                  viewport: { once: !0 },
                  transition: {
                    duration: 0.6,
                  ...
                  className:
                    'mt-4 text-base font-medium text-[#a1a3a3] lg:mt-6 lg:text-xl',
          ...
          (0, t.jsx)('div', {
            className: 'hidden lg:block relative w-full overflow-hidden py-8',
            children: (0, t.jsx)('div', {
              className:
                'flex flex-row flex-nowrap gap-3 items-center justify-center',
              children: u.map((e, i) =>
                (0, t.jsx)(
                  c,
                  {
          ...
          (0, t.jsx)('div', {
            className: 'lg:hidden mx-auto max-w-[1200px] px-6',
            children: (0, t.jsx)('div', {
              className: 'flex flex-col gap-3 w-full',
              children: u.map((e, i) =>
                (0, t.jsx)(
                  d,
                  { index: i, text: e.text, prefersReducedMotion: n },
                  e.id
                )
              ),
            }),
  ...
  (e) => {
    ...
    function x() {
      let e = (0, i.useRef)(null),
        x = (0, o.useReducedMotion)(),
        u = (0, n.useMediaQuery)('(max-width: 768px)'),
        { scrollYProgress: p } = (0, s.useScroll)({
          target: e,
          offset: ['start end', 'end start'],
        }),
        f = (0, l.useSpring)(p, m.motionSprings.ghost),
        h = x ? p : f,
        g = (0, r.useTransform)(h, [0, 1], x ? [0, 0] : [16, -16]),
        b = (0, r.useTransform)(h, [0, 1], x ? ['0%', '0%'] : ['-10%', '10%']);
      return (0, t.jsxs)('section', {
        ref: e,
        className:
              ...
              (0, t.jsx)(a.motion.div, {
                ...
                children: (0, t.jsx)(
                  'video',
                  {
                    ...
                    muted: !0,
                    playsInline: !0,
                    className: `w-full h-full ${u ? 'object-cover object-center opacity-55' : 'object-cover object-right opacity-55'}`,
                    'aria-hidden': 'true',
                  },
                  u ? 'mobile' : 'desktop'
                ),
                ...
                children: [
                  (0, t.jsx)('div', {
                    ...
                    children: (0, t.jsxs)(a.motion.div, {
                      ...
                      children: [
                        (0, t.jsx)(a.motion.div, {
                          variants: m.motionTokens.fadeGhost,
                          initial: x ? 'visible' : 'hidden',
                          whileInView: 'visible',
                          viewport: { once: !0, margin: '-20%' },
                          className: 'mb-8 lg:mb-12 text-center lg:text-left',
                          children: (0, t.jsxs)('h2', {
                            className:
                              'leading-[1.08] tracking-[-0.02em] text-[clamp(32px,5vw,64px)] font-bold',
                            children: [
                              (0, t.jsx)('div', {
                        ...
                        (0, t.jsx)(a.motion.div, {
                          ...
                          children: c.ABOUT_CONTENT.method.steps.map((e) =>
                            (0, t.jsxs)(
                              a.motion.div,
                              {
                                variants: m.motionTokens.riseSoft,
                                className:
  ...
  (e) => {
    ...
    var t = e.i(96148),
      ...
      l = e.i(35315),
      r = e.i(37076);
    let o = ({ text: e, bgColor: o, isFirst: n = !1 }) => {
        let c = (0, i.useRef)(null),
          { scrollYProgress: d } = (0, s.useScroll)({
            target: c,
            offset: ['start end', 'end start'],
          }),
          m = n ? [0.2, 0.4] : [0.22, 0.45],
          x = n ? [0.9, 1] : [0.8, 0.95],
          u = (0, r.cubicBezier)(0.22, 1, 0.36, 1),
          p = (0, l.useTransform)(d, [m[0], m[1], x[0], x[1]], [0, 1, 1, 0]),
          f = (0, l.useTransform)(d, [0.7, 0.95], ['0vh', '-100vh']),
          h = e.split('\n');
        return (0, t.jsx)('section', {
          ref: c,
          className: `relative w-full h-screen flex justify-start overflow-hidden transition-colors duration-500 ease-linear ${n ? 'items-center pt-0' : 'items-start pt-[20vh] md:pt-[20vh] lg:pt-[15vh]'} ${o}`,
          children: (0, t.jsx)('div', {
            ...
            children: (0, t.jsx)(a.motion.div, {
              ...
              children: h.map((e, i) => {
                let s = (0, l.useTransform)(
                  d,
                  [m[0] + 0.02 * i, m[1] + 0.02 * i],
                  ['-100%', '0%'],
                  { ease: u }
                );
                return (0, t.jsx)(
      ...
      c = ({ opacity: e, progress: i }) => {
        let s = (0, r.cubicBezier)(0.22, 1, 0.36, 1),
          o = (0, l.useTransform)(i, [0.05, 0.15], [30, 0], { ease: s }),
          n = (0, l.useTransform)(i, [0.07, 0.17], [30, 0], { ease: s }),
          c = (0, l.useTransform)(i, [0.09, 0.19], [30, 0], { ease: s }),
          d = (0, l.useTransform)(i, [0.11, 0.21], [30, 0], { ease: s }),
          m = (0, l.useTransform)(i, [0.15, 0.25], [20, 0], { ease: s }),
          x = (0, l.useTransform)(i, [0.15, 0.25], [0, 0.8], { ease: s });
        return (0, t.jsx)(a.motion.header, {
          style: { opacity: e },
          className:
      ...
      x = () => {
        let e = i.default.useRef(null),
          { scrollYProgress: a } = (0, s.useScroll)({
            target: e,
            offset: ['start end', 'end end'],
          }),
          x = (0, r.cubicBezier)(0.22, 1, 0.36, 1),
          u = (0, l.useTransform)(a, [0.05, 0.12, 0.85, 0.95], [0, 1, 1, 0], {
            ease: x,
          });
        return (0, t.jsxs)('section', {
          ref: e,
          className: `relative w-full overflow-hidden ${m[0]}`,
          children: [
            (0, t.jsx)(c, { opacity: u, progress: a }),
            d.map((e, i) =>
              (0, t.jsx)(o, { text: e, bgColor: m[i], isFirst: 0 === i }, i)
            ),
            (0, t.jsx)(n, { bgColor: 'bg-bluePrimary' }),
          ],
        });
      };
    e.s(['AboutBeliefs', 0, x, 'default', 0, x], 1590);
  },
  52824,
  (e) => {
    'use strict';
    ...
    function o() {
      ...
      return (0, t.jsx)('section', {
        className:
          'std-grid flex items-center justify-center bg-background py-20 md:py-24',
        'aria-label': 'Fechamento',
        children: (0, t.jsxs)(i.motion.div, {
          variants: r.motionTokens.fadeGhost,
          initial: e ? 'visible' : 'hidden',
          whileInView: 'visible',
          ...
          children: [
            (0, t.jsxs)('div', {
              ...
              children: [
                (0, t.jsx)('div', {
                  className:
                    'h-px w-full max-w-[980px] bg-blueAccent/60 mb-8 md:mb-10',
                }),
                (0, t.jsxs)('h2', {
                  className:
                    'type-h2 font-semibold leading-tight text-white max-w-[900px] lowercase',
                  children: [
                    'hoje sou',
                    ' ',
                    (0, t.jsx)('span', {
                ...
                (0, t.jsx)('div', {
                  className:
                    'h-px w-full max-w-[980px] bg-blueAccent/60 mt-8 md:mt-10',
                }),
              ],
            }),
            (0, t.jsxs)('div', {
              className:
                'mt-10 md:mt-12 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-12 items-center',
              children: [
                (0, t.jsx)('div', {
                  className: 'space-y-5 max-w-[560px] mx-auto text-center',
                  children: l.ABOUT_CONTENT.closing.text.map((e, i) =>
                    (0, t.jsx)(
                      'p',
                      {
                        className:
                          'type-body text-text leading-relaxed opacity-90',
                        children: e,
                      },
                      i
                    )
                ...
                (0, t.jsx)('div', {
                  className:
                    'flex flex-col sm:flex-row lg:flex-col items-center justify-center gap-6 md:gap-8 justify-self-center',
                  children: l.ABOUT_CONTENT.closing.ctas.map((e, i) =>
                    (0, t.jsx)(
                      s.default,
                      { href: e.href, text: e.label, className: 'relative' },
                      i
                    )
                  ),
                }),
