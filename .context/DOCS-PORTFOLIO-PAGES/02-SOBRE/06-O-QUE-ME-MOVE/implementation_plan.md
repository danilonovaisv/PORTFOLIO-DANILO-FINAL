...
return () => {
  ...
  if (bgRef.current) {
    animate(bgRef.current, { backgroundColor: prevColor }, { duration: 0.6, ease: GHOST_EASE_AMBIENT });
  }
};
```
...
// ...
animate(bgRef.current, { backgroundColor: targetColor }, { duration: 0.9, ease: GHOST_EASE });
```
...
// ...
animate(bgRef.current, { backgroundColor: targetColor }, { duration: 0.9, ease: GHOST_EASE_AMBIENT });
```
