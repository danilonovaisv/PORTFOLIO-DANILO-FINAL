...
_(gera Slug, Tags e SEO automaticamente; aceita envio de peças/imagens/vídeos; entrega sempre no mesmo formato sem você relembrar regras)_
...
_(cole como mensagem do usuário quando quiser criar uma landing completa)_
...
- Cliente / Marca:
- Ano (opcional):
- Categoria (branding/campaign/packaging/digital/event/etc.):
- Objetivo do projeto (1–2 linhas):
- Contexto (mercado/concorrência/canal):
- Público (interno/externo; B2C/B2B):
- Meu papel (o que você dirigiu):
- Entregas (lista):
- Resultados / métricas (se houver):
- Restrições (prazo, guidelines, etc.):
...
_(você não precisa escrever isso — o agent aplica sozinho)_
