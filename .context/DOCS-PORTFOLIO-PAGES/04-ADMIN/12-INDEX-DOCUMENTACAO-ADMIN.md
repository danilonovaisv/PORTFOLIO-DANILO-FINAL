...
- `SESSÕES-MD/ADMIN/14-TASK-01-MARKDOWN-ADMIN.md`
- `SESSÕES-MD/ADMIN/15-TASK-02-MOBILE-STAGGERED-MENU.md`
- `SESSÕES-MD/ADMIN/16-TASK-03-POST-MODAL-MIDIA.md`
- `SESSÕES-MD/ADMIN/17-TASK-04-POST-MODAL-TAGS.md`
- `SESSÕES-MD/ADMIN/18-TASK-02-LANDING-PAGE-V3-FIXES.md`
- `SESSÕES-MD/ADMIN/19-TASK-08-PORTFOLIO-SHOWCASE-MODAL-VALIDATION.md`
- `SESSÕES-MD/ADMIN/20-TASK-01-LANDING-V3-YOUTUBE-AUTOPLAY.md`
- `SESSÕES-MD/ADMIN/21-TASK-02-LANDING-V3-FULL-IMAGE.md`
- `SESSÕES-MD/ADMIN/22-TASK-03-THUMBS-MP4.md`
- `SESSÕES-MD/ADMIN/23-TASK-04-HOME-PORTFOLIO-LIVE-CARD-ROTATION.md`
- `SESSÕES-MD/ADMIN/24-TASK-05-HOME-GHOST-CURSOR-INTERACTION.md`
- `SESSÕES-MD/ADMIN/25-TASK-06-HOME-ANIMATED-BACKGROUNDS-AURORA.md`
- `SESSÕES-MD/ADMIN/26-TASK-07-PORTFOLIO-SHOWCASE-MEDIA-FRAMING.md`
- `SESSÕES-MD/ADMIN/27-TASK-08-CTA-MOTION-SYNC.md`
- `SESSÕES-MD/ADMIN/28-TASK-09-ABOUT-BELIEFS-MOBILE.md`
